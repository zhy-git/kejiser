					...
					else 
					{
						...
						else 
						{
							if( $message_type == TM_CYCELBUY_SELLER_SEND ) 
							{
								...
								$message = array( "first" => array( "value" => "您有订单需要发货，请及时安排！", "color" => "#ff0000" ), "keyword2" => array( "title" => "处理进度", "value" => "订单发货通知", "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "订单发货通知", "color" => "#000000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "remark" => array( "value" => "\n感谢您的支持", "color" => "#000000" ) );
								$datas[] = array( "name" => "订单编号", "value" => $data["ordersn"] );
