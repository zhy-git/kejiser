...
if (!function_exists('no_space')) {
     ...
     * @return mixed
     */
    function no_space($key = '', $default = null, $filter = '')
    {
        if(strpos($key,"param.")>=0){
            $old=input($key,$default,$filter);
        }else{
            $old=input('param.'.$key,$default,$filter);
        }
...
if (!function_exists('tp_token')) {
     ...
     * @return string
     */
    function tp_token($name = '__token__', $type = 'md5')
    {
