<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\Webroot\web\weixin\addons\yb_shop\core\/template/index\index.html";i:1547883083;s:61:"D:\Webroot\web\weixin\addons\yb_shop\core\/template/base.html";i:1551756423;}*/ ?>
<!DOCTYPE html>
...
<script>
 ...
 <footer class="footer" style="background: #FFFFFF;height: 25px;margin-top: -5px;padding-top: 10px;line-height: 25px;">
	 ...
	 <div class="container-fluid footer text-center" role="footer">
		 ...
		 <div class="copyright"><?php if(empty($_W['footerleft'])): ?>Powered by <a href="http://www.we7.cc"><b>微擎</b></a>  &copy; 2014-2015 <a href="http://www.we7.cc">www.we7.cc</a><?php else: ?><?php echo $_W['footerleft']; endif; ?></div>
