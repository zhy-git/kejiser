<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/user\integral_details.html";i:1537249574;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537249693;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    <article class="cl pd-20">
        <div class="n_tab_line">
            <a href="" class="n_tab_list">积分详情</a>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <form class="Huiform" method="post" action="__CONF_SITE__admin/user/integral_details" style=" padding: 15px;">
                <div class="text-c">
                    会员名称：
                    <input type="text" class="input-text" value="<?php echo $soname; ?>" style="width:250px" placeholder="输入名称"
                           name="soname">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                ...
                <td><?php if($vo['itype']==1): ?>+<?php else: ?>-<?php endif; ?><?php echo $vo['integral']; ?></td>
                <td><?php if($vo['ctype']==1): ?>+<?php else: ?>-<?php endif; ?><?php echo $vo['consume']; ?></td>
