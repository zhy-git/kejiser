<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/reserve\thing.html";i:1537249589;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    <article class="cl pd-20">
        <div class="n_tab_line">
            <a href="" class="n_tab_list">项目管理</a>
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <form class="Huiform" method="post" action="__CONF_SITE__admin/reserve/thing" style=" padding: 15px;">
                <div class="text-c">
                    <input type="text" class="input-text" value="<?php echo $soname; ?>" style="width:250px" placeholder="输入分类"
                           name="soname">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                <td><img src="<?php echo $vo['img']; ?>" style="width: 50px;height: 50px;"></td>
                ...
                <td>
                    <a title="编辑" href="javascript:;" onclick="assort_edit('<?php echo $vo['id']; ?>')" class="ml-5"
                       style="text-decoration:none">编辑</a>
                    <a title="删除" href="javascript:;" onclick="assort_del('<?php echo $vo['id']; ?>')" class="ml-5"
...
<script type="text/javascript">
    function assort_add() {
        location.href = "<?php echo url('reserve/thing_add'); ?>";
    }
    function assort_edit(id) {
        location.href = "<?php echo url('reserve/thing_edit'); ?>&id=" + id;
    }
    var lock = false;
