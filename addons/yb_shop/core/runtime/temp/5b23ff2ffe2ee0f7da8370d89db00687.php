<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/printer\index.html";i:1537249593;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537249693;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    ...
    <article class="cl pd-20">
        ...
        <div class="n_tab_line">
            ...
            <a href="" class="n_tab_list">打印机管理</a>

            <div class="l n_tab_add" style="width: auto">
                <a style="line-height: 21px;" class="btn btn-search radius" href="<?php echo url('printer/editprinter'); ?>">
                    <i class="Hui-iconfont">&#xe600;</i> 添加打印机
                </a>
            </div>
        </div>
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                ...
                <td><?php echo $type[$vo['printer_type']]; ?></td>
                <td>
                    <a title="编辑" href="<?php echo url('printer/editprinter',['pid'=>$vo['id']]); ?>" class="ml-5" style="text-decoration:none">编辑</a>
                    <a title="删除" href="javascript:;" onclick="printer_del('<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none">删除</a>
                </td>
            </tr>
...
<script type="text/javascript">
    function printer_del(id) {
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type : "post",
                url : "<?php echo url('printer/printer_del'); ?>",
                data: {pid: id},
                dataType:"json",
