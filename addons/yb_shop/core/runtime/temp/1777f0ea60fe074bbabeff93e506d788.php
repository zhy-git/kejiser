<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/config\wechats.html";i:1537249687;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form form-horizontal">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" autocomplete="off" value="<?php echo $account_wechats['name']; ?>"
                       placeholder="请点击左侧 返回系统 在小程序管理界面 配置相关参数" disabled class="input-text" id="name">
                <p>公众号名称 如需更改 请 <a href="<?php echo $siteroot; ?>">返回平台</a> 在【微信公众号管理界面】 配置相关参数</p>
            </div>
        </div>
        <div class="row cl" style="margin-top:2px;">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公众号编号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" autocomplete="off" value="<?php echo $account_wechats['key']; ?>"
                       placeholder="请点击左侧 返回系统 在小程序管理界面 配置相关参数" disabled class="input-text" id="key" name="key">
                <p>公众号 APPID 如需更改 请 <a href="<?php echo $siteroot; ?>">返回平台</a> 在【微信公众号管理界面】 配置相关参数</p>
            </div>
        </div>
        <div class="row cl" style="margin-top:2px;">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公众号秘匙：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" autocomplete="off" value="<?php echo $account_wechats['secret']; ?>"
                       placeholder="请点击左侧 返回系统 在微信公众号管理界面 配置相关参数" disabled class="input-text" id="secret"
                       name="secret">
                <p>公众号 APP_SECRET 如需更改 请 <a href="<?php echo $siteroot; ?>">返回平台</a> 在【微信公众号管理界面】 配置相关参数</p>
            </div>
        </div>
<!--        <div class="row cl" style="margin-top:2px;">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>H5页面入口：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" autocomplete="off" value="<?php echo $account_wechats['h5_url']; ?>" class="input-text" disabled>
            </div>
        </div>-->
        <div class="row cl">
    ...
    <input type="hidden" id="id" value="<?php echo $account_wechats['id']; ?>">

    <input type="hidden" id="account_wechats_uniacid" value="<?php echo $account_wechats['uniacid']; ?>">
</article>
...
<script type="text/javascript">
    function addWechatsAjax() {
        ...
        if(key==""){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('config/wechats'); ?>",
                data: {
                    'id': id,
                ...
                success: function (data) {
                    if (data["code"] > 0) {
                        layer.msg('提交成功!', {icon: 1, time: 1000}, function () {
                            window.parent.location.href = "<?php echo url('config/wechats'); ?>";
                        });
                    } else {
