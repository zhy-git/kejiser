<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/league\copyright.html";i:1537249639;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<article class="cl pd-20">
    ...
    <div class="n_tab_line">
        ...
        <a href="<?php echo url('user/user_list'); ?>" class="n_tab_list">版权信息</a>
    ...
    <div class="form_li">
        站点名称：<input class="form_input" style="width: 500px;" type="text" name="site_name"
                    value="<?php echo $list['site_name']; ?>"/>
    </div>
    <div class="form_li">
        版权信息：<input class="form_input" style="width: 500px;" type="text" name="content" value="<?php echo $list['content']; ?>"/>
    </div>

<?php if($WXAPP_TYPE != 100): ?>
    <div class="form_lis" style="text-align: left;">
        返回系统跳转：
        <input type="radio" name="back" value="0" <?php if($list['back_type'] == 0): ?> checked="checked" <?php endif; ?> style="margin-right: 2px;"/>主系统
        <input type="radio" name="back" value="1" <?php if($list['back_type'] == 1): ?> checked="checked" <?php endif; ?> style="margin-left: 8px;margin-right: 2px;"/>独立页面
    </div>
<?php endif; ?>

    <div class="form_about" style="width: 570px;margin: 0 auto;text-align: left;">
        <input class="btn btn-primary radius" onclick="comm('<?php echo $list['id']; ?>');" type="button"
               value="&nbsp;&nbsp;保存&nbsp;&nbsp;">
