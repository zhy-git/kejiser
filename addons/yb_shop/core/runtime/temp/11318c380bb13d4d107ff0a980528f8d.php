<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/custom\index.html";i:1539316502;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;s:75:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/custom\left.html";i:1539392745;s:77:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/custom\center.html";i:1539392746;s:76:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/custom\right.html";i:1539392744;}*/ ?>
<!DOCTYPE html>
                                                                ...
                                                                <div :style="'height:'+(page.show_tabbar == 'true' ? 520 : 570)+'px;background-color:'+page.bg_color+';background-image: url('+page.bg_img+');background-repeat:no-repeat;background-size:100%;-moz-background-size:100%;'"
                                                                    ...
                                                                    <ul class="form_component style_1 clearfix ui-sortable">
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <ucenter_cell
                                                                                    v-if="item.type=='order' || item.type=='follow' || item.type=='coupon' || item.type=='book' || item.type=='kjm' || item.type=='kjo' || item.type=='ptm' || item.type=='pto' || item.type=='kefu' || item.type=='address' || item.type=='about' || item.type=='fenxiao'"
                                                                                    :img="item.img"
                                                                                    :name="item.name"
                                                                                    :index="index">
                                                                            </ucenter_cell>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data){
                    if(data.all_data){bannerVM.all_data=data.all_data;}
        ...
        if(page_flag == '2' || page_flag == '3' || flag == 1)
        {
            ...
            if(flag == 1 && id == "0")
            {
                layer.prompt({title: '输入模版名称', formType: 0}, function (text, index) {
                    dosave(data,page_flag,id,src,text,flag);
                });
            }
            else
            {
                dosave(data,page_flag,id,src,bannerVM.page.name,flag);
            }
        });
        }
        else
    ...
    function dosave(data,page_flag,id,src,name,flag) {
