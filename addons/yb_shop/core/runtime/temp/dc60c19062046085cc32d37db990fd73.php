<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/activity\share_set.html";i:1538541948;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
	...
	<div class="form form-horizontal">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"><div style="float:left;">
				...
				<div style="float:left;padding-left:10px;"><p>提示：开启分销内购，分销商自己购买商品，享受一级佣金</p></div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"><div style="float:left;">
				<input type="radio" value="0" name="share_condition" <?php if($share['share_condition']=='0') echo("checked");?> >不审核&nbsp;&nbsp;
		...
		<div class="row cl" style="">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="min_money" value="<?php echo $share['min_money']; ?>" class="input-text" > 元
			</div>
		</div>
		<div class="row cl" style="">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>每日提现上限：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="max_money" value="<?php echo $share['max_money']; ?>" class="input-text" placeholder="0元表示不限制每日提现金额"> 元
			</div>
		</div>
		<div class="row cl" style="">
			<label class="form-label col-xs-4 col-sm-2">用户须知：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="content" id="content" cols="80" rows="10" style="border: solid 1px #ddd;"><?php echo $share['content']; ?></textarea>
			</div>
		</div>
		<div class="row cl" style="">
			<label class="form-label col-xs-4 col-sm-2">分销协议：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="agree" id="agree" cols="80" rows="10" style="border: solid 1px #ddd;"><?php echo $share['agree']; ?></textarea>
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    function share_set() {
        ...
        $.ajax({
            type : "post",
            url : "<?php echo url('activity/share_set'); ?>",
            data : {
                'level' : level,
                'pay_type' : pay_type,
                'min_money' : min_money,
            ...
            success : function(data) {
                if (data == '2') {
                    layer.msg('修改成功!',{icon:1,time:1000},function () {
                        window.location.href="<?php echo url('activity/share_set'); ?>";
                    });
                }else{
