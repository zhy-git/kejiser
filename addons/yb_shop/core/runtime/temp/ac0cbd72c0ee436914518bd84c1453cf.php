<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/message\index.html";i:1537249602;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="mt-20">
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tr class="text-c va-m">
                        ...
                        <td>
                            <input type="text" autocomplete="off" value="<?php echo $list['AT0210']; ?>" class="input-text" id="AT0210">
                        </td>
                    </tr>
                    <tr class="text-c va-m">
                        <td>AT1213</td>
                        <td>积分兑换成功通知</td>
                        <td>备注、累计积分、可用积分【请按照关键字顺序设置】</td>
                        <td>
                            <input type="text" autocomplete="off" value="<?php echo $list['AT1213']; ?>" class="input-text" id="AT1213">
                        </td>
                    </tr>
                    <tr class="text-c va-m">
                        <td>AT0048</td>
                        <td>支付成功通知</td>
                        <td>订单号、会员昵称、物品名称、支付金额、订单金额、获取积分、可用积分、支付时间、备注【请按照关键字顺序设置】</td>
                        <td>
                            <input type="text" autocomplete="off" value="<?php echo $list['AT0048']; ?>" class="input-text" id="AT0048">
                        </td>
                    </tr>
                    </tbody>
                ...
                <div class="row cl">
                    ...
                    <div class="col-xs-8 col-sm-9">
                        ...
                        <input class="btn btn-primary radius" onclick="temp_save('<?php echo $lone; ?>')" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;" style="padding:6px 12px;">
...
function temp_save(id) {
    if(!flags){
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('message/index'); ?>",
            data: {
                id: id,
                /*AT0009: $('#AT0009').val(),*/
                AT0210: $('#AT0210').val(),
