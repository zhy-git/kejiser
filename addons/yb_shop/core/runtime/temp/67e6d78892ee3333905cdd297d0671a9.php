<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/sappl\index.html";i:1537249581;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="l n_tab_add"><a href="javascript:;" onclick="add_attr_mod('添加小程序','__CONF_SITE__admin/sappl/sappl_add','600','300')"><i class="Hui-iconfont">&#xe600;</i>添加小程序跳转地址</a></div>

                        </div>

                    </div>
<div class="cl pd-5 bg-1 bk-gray mt-20">
        <form class="Huiform" method="POST" action="__CONF_SITE__admin/sappl/index" style=" padding: 15px;">

            <div class="text-c"> 小程序：

               <input type="text" class="input-text" value="<?php echo $sapp_name; ?>" style="width:250px" placeholder="小程序名称"  name="sapp_name">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                ...
                <td>
                    <a title="编辑" href="javascript:;" onclick="attr_mod_edit('分类编辑','__CONF_SITE__admin/Sappl/sappl_edit&id=<?php echo $vo['id']; ?>','600','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
    ...
    function attr_mod_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                ...
                url : "<?php echo url('sappl/sappl_del'); ?>",
