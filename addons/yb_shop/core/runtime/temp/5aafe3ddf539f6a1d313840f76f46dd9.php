<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/activity\share_pay.html";i:1537249725;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    ...
    <div id="tab_demo" class="HuiTab" style="margin-bottom: 15px; position:relative;">
        <div class="tabBar clearfix">
            <span class="current">佣金设置</span>
        </div>
    </div>
    <div>
    <div class="mt-20">
        <?php if($share['level'] == '6'): ?>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td style="width:5%;">　</td>
                <td style="width:80%; text-align: left;">
                    <input type="text" value="<?php echo (isset($share['first_name']) && ($share['first_name'] !== '')?$share['first_name']:'一级'); ?>" class="input-text" id="fname">
                </td>
            </tr>
            <tr class="text-c">
                ...
                <td style="width:5%;">　</td>
                <td style="width:80%; text-align: left;">
                    <input type="text" value="<?php echo (isset($share['first']) && ($share['first'] !== '')?$share['first']:'0.00'); ?>" class="input-text" id="fprice">
                    <span class="span_type"><?php echo $share['icon']; ?></span>
                </td>
            </tr>
                <?php if($share['second'] != '-1'): ?>
                <tr class="text-c">
                    <td style="text-align: right;width:15%;">二级名称</td>
                    <td style="width:5%;">　</td>
                    <td style="width:80%; text-align: left;">
                        <input type="text" value="<?php echo (isset($share['second_name']) && ($share['second_name'] !== '')?$share['second_name']:'二级'); ?>" class="input-text" id="sname">
                    </td>
                </tr>
                <tr class="text-c">
                    ...
                    <td style="width:5%;">　</td>
                    <td style="width:80%; text-align: left;">
                        <input type="text" value="<?php echo (isset($share['second']) && ($share['second'] !== '')?$share['second']:'0.00'); ?>" class="input-text" id="sprice">
                        <span class="span_type"><?php echo $share['icon']; ?></span>
                    </td>
                </tr>
                <?php endif; if($share['third'] != '-1'): ?>
                <tr class="text-c">
                    <td style="text-align: right;width:15%;">三级名称</td>
                    <td style="width:5%;">　</td>
                    <td style="width:80%; text-align: left;">
                        <input type="text" value="<?php echo (isset($share['third_name']) && ($share['third_name'] !== '')?$share['third_name']:'三级'); ?>" class="input-text" id="tname">
                    </td>
                </tr>
                <tr class="text-c">
                    ...
                    <td style="width:5%;">　</td>
                    <td style="width:80%; text-align: left;">
                        <input type="text" value="<?php echo (isset($share['third']) && ($share['third'] !== '')?$share['third']:'0.00'); ?>" class="input-text" id="tprice">
                        <span class="span_type"><?php echo $share['icon']; ?></span>
                    </td>
                </tr>
                <?php endif; ?>
        ...
        <div class="row cl">
            ...
            <div class="col-xs-7 col-sm-7">
                <input class="btn btn-primary radius" onclick="save_pay()" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;" style="padding:6px 12px;">
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<script type="text/javascript">
    ...
    function save_pay() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('activity/share_pay'); ?>",
            data: {
                'price_type':s,
