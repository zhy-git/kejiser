<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/goods\goods_attr_mod.html";i:1537249672;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div id="tab_demo" class="HuiTab" style="margin-top: 0px; position: relative;">
                        ...
                        <div class="tabBar clearfix">
                            ...
                            <span  class="current" onclick="window.location.href='<?php echo url('goods/goods_attr_mod'); ?>'">分类管理</span>
                            <span  onclick="window.location.href='<?php echo url('goods/goods_spec'); ?>'">规格管理</span>
                            <span  onclick="window.location.href='<?php echo url('goods/attributelist'); ?>'">属性管理</span>

<div class="l n_tab_add"><a href="javascript:;" onclick="add_attr_mod('添加分类','__CONF_SITE__admin/goods/add_attr_mod','600','700')"><i class="Hui-iconfont">&#xe600;</i>添加分类</a></div>

                        </div>

                    </div>
<div class="cl pd-5 bg-1 bk-gray mt-20">
        <form class="Huiform" method="post" action="__CONF_SITE__admin/goods/goods_attr_mod" target="_self" style=" padding: 15px;">

            <div class="text-c"> 分类名称：

               <input type="text" class="input-text" value="<?php echo $search_text; ?>" style="width:250px" placeholder="分类名称"  name="search_text">

                <button type="submit" class="btn btn-search radius"  name=""><i class="Hui-iconfont">&#xe665;</i> 搜分类</button>
...
-->
            ...
            <tr class="text-c">
                ...
                <td><?php echo $vo['spec_value_str']; ?></td>

                <td><?php echo $vo['value_str']; ?></td>

                <td>

                    <?php if($vo['is_use']==1): ?>

                    <a style="text-decoration:none" onClick="goods_attr_stop(this,'<?php echo $vo['attr_id']; ?>')" href="javascript:;" title="已启用"><span class="label label-success radius">已启用</span></a>

                    <?php endif; if($vo['is_use']==0): ?>

                    <a style="text-decoration:none" onClick="goods_attr_start(this,'<?php echo $vo['attr_id']; ?>')" href="javascript:;" title="已停用"><span class="label label-default radius">已停用</span></a>
                ...
                <td>
                    ...
                    <a title="编辑" href="javascript:;" onclick="attr_mod_edit('分类编辑','__CONF_SITE__admin/goods/attr_mod_edit&mod_id=<?php echo $vo['attr_id']; ?>','800','700')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="attr_mod_del(this,'<?php echo $vo['attr_id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
...
<script type="text/javascript">
    ...
    function add_attr_mod(title,url,w,h){
    ...
    function attr_mod_edit(title,url,w,h) {
        layer_show(title,url,w,h);
    }
    /*分组-停用*/
    ...
    function goods_attr_stop(obj,id){
        ...
        layer.confirm('确认要停用吗？',function(index){
            ...
            $.ajax({
                ...
                url : "<?php echo url('goods/attrModOff'); ?>",
    ...
    function goods_attr_start(obj,id){
        ...
        layer.confirm('确认要启用吗？',function(index){
            ...
            $.ajax({
                ...
                url : "<?php echo url('goods/attrModOn'); ?>",
    ...
    function attr_mod_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                ...
                url : "<?php echo url('goods/attr_mod_del'); ?>",
