<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/league\index.html";i:1537249637;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="n_tab_line">
            ...
            <a href="<?php echo url('league/setting'); ?>" class="n_tab_list">APP登录密码设置</a>
...
<div class="form_li">
用户名：<input class="form_input" type="text" name="name" <?php if(!empty($list['account'])): ?>value="<?php echo $list['account']; ?>" style="background-color:#c3c5c5;" disabled<?php endif; ?> /></div>
<div class="form_li">
