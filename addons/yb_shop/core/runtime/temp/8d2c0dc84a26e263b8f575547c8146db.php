<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/count\order_count.html";i:1537249684;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    <article class="cl pd-20">
        <div class="n_tab_line">
            <a href="javascript:;" class="n_tab_list">订单统计</a>
            </div>
<!--        <p class="f-20 text-success">订单统计</p>-->
        <div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-bottom: 15px;">
        <div class="text-c" style="padding: 15px;">
            日期范围：
            <input type="text" onfocus="WdatePicker({ dateFmt: 'yyyy-MM'})" id="star_time" value="<?php echo $star_time; ?>" name="star_time" class="input-text Wdate" style="width:120px;">
            <button type="submit" class="btn btn-search radius"  name="" onclick="search()"><i class="Hui-iconfont">&#xe665;</i>搜索</button>
        </div></div>
            ...
            <div class="panel-body">
                <ul class="mt5">
					...
					<span class="w210 fl h30" style="display:block;">
						...
						近30天下单金额：<strong id="order_money">元</strong>
					</span>
                    <span class="w210 fl h30" style="display:block;">
						<i title="店铺从昨天开始最近30天有效订单的总订单数" class="tip icon-question-sign"></i>
						近30天下单量：<strong id="order_num"></strong>
					</span>
                    </li>
                </ul>
            </div>
