<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/activity\share_other.html";i:1537249725;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
        ...
        <div>
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody id="tbody">
                    <?php if(is_array($share) || $share instanceof \think\Collection || $share instanceof \think\Paginator): if( count($share)==0 ) : echo "" ;else: $k=0; foreach($share as $key=>$vo): ++$k; ?>
                    <tr class="text-c va-m">
                        <td>
                            <span style="text-align: center" class="share_span" span_targ="mytarg<?php echo $k; ?>" ><?php echo $share_default[$k]; ?></span>
                        </td>
                        <td>==>></td>
                        <td>
                            <input type="text" value="<?php echo $vo; ?>" onchange="set_share_title('<?php echo $k; ?>',this.value)" class="input-common" id="mytarg<?php echo $k; ?>" style="text-align: center">
                        </td>
                    </tr>
