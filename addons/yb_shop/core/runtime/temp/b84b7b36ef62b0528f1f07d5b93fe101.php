<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/www/wwwroot/ceshi.ahwiyun.cn/addons/yb_shop/core//template/activity/miaosha.html";i:1544515648;s:69:"/www/wwwroot/ceshi.ahwiyun.cn/addons/yb_shop/core//template/base.html";i:1544515647;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    <article class="cl pd-20">
        <div class="tabBar clearfix">
            <span class="current" onclick="window.location.href=('__CONF_SITE__admin/activity/miaosha')">活动列表</span>
            <span onclick="window.location.href=('__CONF_SITE__admin/activity/ac_order&type=1')" >活动订单</span>
            <div onclick="layer_open('添加活动','__CONF_SITE__admin/activity/add_miaosha',900,800)"  class="n_tab_add"><i class="Hui-iconfont">&#xe600;</i>添加活动</div>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <form class="Huiform" method="post" action="<?php echo url('activity/miaosha'); ?>" target="_self" style="padding:15px;">
                <div class="text-c"> 活动名称：
                    <input type="text" class="input-text" value="<?php echo $search_text; ?>" style="width:250px" placeholder="输入活动名称"  name="search_text">
        ...
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="<?php echo $vo['pic']; ?>" width="50"></td>
                    <td>￥<?php echo $vo['oprice']; ?></td>
                    <td>￥<?php echo $vo['nprice']; ?></td>
                    <td><?php echo $vo['max_pre']; ?></td>
                    <td><?php echo $vo['sell']; ?></td>
                    <td><?php echo $vo['kucun']; ?></td>
                    <td><?php echo $vo['stime']; ?><br><?php echo $vo['etime']; ?></td>
                    <td><?php echo $vo['now']; ?></td>
                    <td>
                        <a onclick="layer_open('活动编辑','__CONF_SITE__admin/activity/edit_miaosha&id=<?php echo $vo['id']; ?>&type=1','900','800')" href="javascript:;" style="text-decoration:none;color:#7dd07d;margin-right:15px;">修改</a>
                        <?php if($vo['status']==2): ?>
                        <a onclick="do_change('<?php echo $vo['id']; ?>',1)" href="#" style="text-decoration:none;color:#7dd07d;margin-right:15px;">启用</a>
                        <?php else: ?>
                        <a onclick="do_change('<?php echo $vo['id']; ?>',2)" href="#" style="text-decoration:none;color:#7dd07d;margin-right:15px;">停用</a>
                        <?php endif; ?>
                        <a onclick="bar_del('<?php echo $vo['id']; ?>')" href="#" style="text-decoration:none;color:#7dd07d;margin-right:15px;">删除</a>
                        <?php if($vo['show_order']>0): ?>
                        <a onclick="window.location.href=('__CONF_SITE__admin/activity/ac_order&acid=<?php echo $vo['id']; ?>&type=1')" href="javascript:;" style="text-decoration:none;color:#7dd07d;margin-right:15px;">查看订单</a>
                        <?php endif; ?>
                    </td>
                </tr>
...
<script type="text/javascript">
    function do_change(id,s) {
        ...
        layer.confirm(d,function(){
            $.ajax({
                type : "post",
                url : "<?php echo url('activity/change'); ?>",
                data : {
                    "id" : id,
                    "status" :s,
                    "type":1
