<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/ceshi.ahwiyun.cn/addons/yb_shop/core//template/menu/universal.html";i:1542937310;s:69:"/www/wwwroot/ceshi.ahwiyun.cn/addons/yb_shop/core//template/base.html";i:1544515647;}*/ ?>
<!DOCTYPE html>
        ...
        <div>
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody id="tbody">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$r): ?>
                    <tr class="text-c va-m">
                        <td><?php echo subtext($r['name'],20); ?></td>
                        <td><a target="_blank" href="<?php echo $r['img']; ?>"><img src="<?php echo $r['img']; ?>" width="50" height="50"></a></td>
                        <td>yb_shop/pages/power/index?id=<?php echo $r['id']; ?></td>
                        <td><?php echo date("Y-m-d H:i:s",$r['create_time']); ?></td>
                        <td>
                            <a style="text-decoration:none;color:#0066cc;" title="复制" href="javascript:void(0);" onclick="universal_copy(this,'<?php echo $r['id']; ?>')">复制</a>
                            <a style="text-decoration:none;color:#0066cc;" title="编辑" href="__CONF_SITE__admin/custom/power&id=<?php echo $r['id']; ?>">编辑页面</a>
                            <a style="text-decoration:none;color:#0066cc;" title="删除" href="javascript:void(0);" onclick="universal_del(this,'<?php echo $r['id']; ?>')">删除</a>
                            <a style="text-decoration:none;color:#0066cc;" title="复制" href="javascript:void(0);" onclick="copy_now('wxpath<?php echo $k; ?>')" id="wxpath<?php echo $k; ?>" data-clipboard-text="yb_shop/pages/power/index?id=<?php echo $r['id']; ?>">复制链接</a>
                        </td>
                    </tr>
