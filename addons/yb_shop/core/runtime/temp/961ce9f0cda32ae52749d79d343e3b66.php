<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/config\wq_upload.html";i:1537249686;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<article class="cl pd-20">
    ...
    <div class="form form-horizontal">
        <div class="row cl" style="margin: 0px;">
            ...
            <input type="text" autocomplete="off" value="<?php echo $wx_tmpl['value']; ?>" onchange="set_wx_tmpl(this.value)" placeholder="微信模板库ID" class="input-text" id="wx_tmpl">
        </div>
    </div>
    <?php endif; ?>
    <div class="form form-horizontal">
        ...
        <div class="row cl" style="margin: 0px;margin-top: 30px;">
            ...
            <div class="formControls col-xs-8 col-sm-9" id="wx_append">
                ...
                <span id="wx_info"><?php echo $authorized; ?></span>
...
<script>
    ...
    function do_up() {
        ...
        $.ajax({
            type : "post",
            url : "<?php echo url('config/WeChatShang'); ?>",
            dataType : "json",
    ...
    function getWxInfo() {
        $.ajax({
            type : "post",
            url : "<?php echo url('config/receive_appid'); ?>",
            dataType : "json",
            success : function(data) {
                console.log(data);
                if (data['status']==0){
    ...
    function fabu() {
        $.ajax({
            ...
            type : "post",
            url : "<?php echo url('admin/config/release'); ?>",
    ...
    function withdraw(){
        $.ajax({
            type : "post",
            url : "<?php echo url('config/wx_withdraw'); ?>",
            dataType : "json",
            success : function(data) {
                if (data['errcode']==0){
    ...
    function set_wx_tmpl(tmpl_id) {
        $.ajax({
            type : "post",
            url : "<?php echo url('config/set_wx_tmpl'); ?>",
            data:{
                'tmpl_id':tmpl_id
            },
            dataType : "json",
    ...
    function tijiao() {
        $.ajax({
            type : "post",
            url : "<?php echo url('config/tijiaoshenhe'); ?>",
            dataType : "json",
            success : function(data) {
                if (data['errcode']>0){
