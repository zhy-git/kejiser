<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/index\index.html";i:1541410607;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1541418050;}*/ ?>
<!DOCTYPE html>
		...
		<article class="cl pd-20" style="padding-top:0;">
			...
			<div class="goods-prompt" style="border-radius: 6px !important; width:100% !important;">
				...
				<div class="goods-state a-line order" style="height: 135px;padding-top: 30px;">
					<ul>
						<li onclick="location.href='__CONF_SITE__admin/order/orderlist?status=0';" style="border-right:1px solid #eee;"><div class="index_icon_box"><img src="/addons/yb_shop/core/public/images/index_order_icon01.jpg"></div><div class="index_info_box"><h4 class="daifukuan" style="font-size:32px;margin-bottom:0 !important;"><?php echo (isset($dzf) && ($dzf !== '')?$dzf:0); ?></h4>待支付</div></li>
						<li onclick="location.href='__CONF_SITE__admin/order/orderlist?status=1';" style="border-right:1px solid #eee;"><div class="index_icon_box"><img src="/addons/yb_shop/core/public/images/index_order_icon02.jpg"></div><div class="index_info_box"><h4 class="daifahuo" style="font-size:32px;margin-bottom:0 !important;"><?php echo (isset($dfh) && ($dfh !== '')?$dfh:0); ?></h4>待发货</div></li>
						<li onclick="location.href='__CONF_SITE__admin/order/orderlist?status=2';" style="border-right:1px solid #eee;"><div class="index_icon_box"><img src="/addons/yb_shop/core/public/images/index_order_icon03.jpg"></div><div class="index_info_box"><h4 class="yifahuo" style="font-size:32px;margin-bottom:0 !important;"><?php echo (isset($yfh) && ($yfh !== '')?$yfh:0); ?></h4>已发货</div></li>
						<li onclick="location.href='__CONF_SITE__admin/order/orderlist?status=3';" style="border-right:1px solid #eee;"><div class="index_icon_box"><img src="/addons/yb_shop/core/public/images/index_order_icon04.jpg"></div><div class="index_info_box"><h4 class="yishouhuo" style="font-size:32px;margin-bottom:0 !important;"><?php echo (isset($yqs) && ($yqs !== '')?$yqs:0); ?></h4>已签收</div></li>
						<li onclick="location.href='__CONF_SITE__admin/order/orderlist?status=-1';"><div class="index_icon_box"><img src="/addons/yb_shop/core/public/images/index_order_icon05.jpg"></div><div class="index_info_box"><h4 class="tuikuanzhong" style="font-size:32px;margin-bottom:0 !important;"><?php echo (isset($yqx) && ($yqx !== '')?$yqx:0); ?></h4>已取消</div></li>
					</ul>
				</div>
			</div>
			<?php endif; ?>
