<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/publish\wxapp.html";i:1541417953;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1541418050;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form form-horizontal">
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-0" style="display: flex; justify-content: center; align-items: center; width: 100%;">
                <iframe style="width: 100%; height: 600px;" frameborder="0" src="https://ad.vip.ly100.wang/admin/publish/wxapp?userid=<?php echo $userid; ?>&appid=<?php echo $appid; ?>&appname=<?php echo $appname; ?>&url=<?php echo $url; ?>&pages=<?php echo $pages; ?>&lastv=<?php echo $last['version']; ?>"></iframe>
            </div>
        </div>
    </div>
</article>
