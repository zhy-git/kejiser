<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\Webroot\web\weixin\addons\yb_shop\core\/template/config\wapppay.html";i:1542937341;s:61:"D:\Webroot\web\weixin\addons\yb_shop\core\/template/base.html";i:1551756423;}*/ ?>
<!DOCTYPE html>
...
<form id="main_form" method="post">
	...
	<div class="form form-horizontal" id="main">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $wxappinfo['name']; ?>" placeholder="请点击左侧 返回系统 在小程序管理界面 配置相关参数" readonly class="input-text" id="APP_NAME" name="APP_NAME">
				<p >小程序名称 如需更改 请 <a href="<?php echo $siteroot; ?>">返回平台</a> 在【小程序管理界面】 配置相关参数</p>
			</div>
		</div>
		<div class="row cl" style="margin-top:2px;">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序应用编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $wxappinfo['key']; ?>" placeholder="请点击左侧 返回系统 在小程序管理界面 配置相关参数" readonly class="input-text" id="APP_ID" name="APP_ID">
				<p >小程序应用编号 APPID 如需更改 请 <a href="<?php echo $siteroot; ?>">返回平台</a> 在【小程序管理界面】 配置相关参数</p>
			</div>
		</div>
		<div class="row cl" style="margin-top:2px;">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序应用秘匙：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $wxappinfo['secret']; ?>" placeholder="请点击左侧 返回系统 在小程序管理界面 配置相关参数" readonly class="input-text" id="APP_SECRET" name="APP_SECRET">
				<p >小程序应用秘匙 APP_SECRET 如需更改 请 <a href="<?php echo $siteroot; ?>">返回平台</a> 在【小程序管理界面】 配置相关参数</p>
			</div>
		</div>
		<div v-if="pay_type == 0">
		<div class="row cl" style="margin-top:2px;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info['value']['APP_MCHID']; ?>" placeholder="请输入APP_MCHID" class="input-text" id="APP_MCHID" name="APP_MCHID">
		...
		<div class="row cl" style="margin-top:2px;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info['value']['APP_KEY']; ?>" placeholder="请输入APP_KEY" class="input-text" id="APP_KEY" name="APP_KEY">
		...
		<div v-if="pay_type == 1">
			<div class="row cl" style="margin-top:2px;">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" autocomplete="off" value="<?php echo $info['value']['SERVICE_APPID']; ?>" placeholder="请输入APP_MCHID" class="input-text" id="SERVICE_APPID" name="SERVICE_APPID">
			...
			<div class="row cl" style="margin-top:2px;">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" autocomplete="off" value="<?php echo $info['value']['SERVICE_MCHID']; ?>" placeholder="请输入APP_KEY" class="input-text" id="SERVICE_MCHID" name="SERVICE_MCHID">
			...
			<div class="row cl" style="margin-top:2px;">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" autocomplete="off" value="<?php echo $info['value']['SERVICE_KEY']; ?>" placeholder="请输入APP_KEY" class="input-text" id="SERVICE_KEY" name="SERVICE_KEY">
			...
			<div class="row cl" style="margin-top:2px;">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" autocomplete="off" value="<?php echo $info['value']['SUB_MCHID']; ?>" placeholder="请输入APP_MCHID" class="input-text" id="SUB_MCHID" name="SUB_MCHID">
	...
	<input type="hidden" id="bus_id" value="<?php echo $user_info['id']; ?>">
...
<script type="text/javascript">
    var vm = new Vue({
        el: '#main',
        data: {
			pay_type:<?php echo $info['value']['PAY_TYPE']; ?>
        }
    });
    ...
    function addAdvertAjax() {
        ...
        flag = true;
        $.ajax({
            url: "<?php echo url('config/WAppPay'); ?>",
            type: 'POST',
            cache: false,
            ...
            success:function (res) {
                ...
                if (res["code"] > 0) {
                    layer.msg('提交成功!',{icon:1,time:1000},function () {
                        window.parent.location.href="<?php echo url('config/wapppay'); ?>";
                    });
                }else{
