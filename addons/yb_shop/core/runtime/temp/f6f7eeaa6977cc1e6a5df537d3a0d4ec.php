<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/league\setting.html";i:1537249636;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="n_tab_line">
            ...
            <a href="<?php echo url('league/setting'); ?>" class="n_tab_list">APP信息设置</a>
...
<div class="form_li">
    手机/微信：<input class="form_input" type="text" name="phone" value="<?php echo $list['phone']; ?>" />
</div>
<div class="form_li">
    &nbsp;&nbsp;QQ号码：<input class="form_input" type="text" name="qq" value="<?php echo $list['qq']; ?>">
</div>
<div class="form_li">
    &nbsp;公司地址：<input class="form_input" type="text" name="address" value="<?php echo $list['address']; ?>">
</div>
<div class="form_li">
    &nbsp;关于我们：<input class="form_input" type="text" name="title" value="<?php echo $list['title']; ?>" placeholder="请输入标题 例如：关于我们XXXX">
</div>
<div class="form_lt">
    <textarea id="editor" name="content" style="height: 450px;width:100%;"><?php echo $list['content']; ?></textarea>
</div>
<div class="form_li" style="margin-top: 0px;">
    <input class="btn btn-primary radius" onclick="comm('<?php echo $list['id']; ?>');" type="button" value="&nbsp;&nbsp;保存&nbsp;&nbsp;">
</div>
...
<script type="text/javascript" src="/public/menu/js/jquery.artdialog.js"></script>
<script type="text/javascript" src="/public/menu/js/iframetools.js"></script>
<script>
