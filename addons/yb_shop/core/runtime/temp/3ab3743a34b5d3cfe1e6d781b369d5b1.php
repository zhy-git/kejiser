<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\Webroot\web\weixin\addons\yb_shop\core\/template/config\send_sms.html";i:1546825067;s:61:"D:\Webroot\web\weixin\addons\yb_shop\core\/template/base.html";i:1551756423;}*/ ?>
<!DOCTYPE html>
...
<article class="cl pd-20">
	<div class="n_tab_line">
            <a href="<?php echo url('config/send_sms'); ?>" class="n_tab_list">短信通知</a>
            <div class="cl"></div>
        </div>
	<span>下单成功通知</span>
	<form action="" method="post" class="form form-horizontal" id="">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="skin-minimal">
					<div class="radio-box" style="padding-left:0;">
						<input type="radio" value="2" <?php if($info1['status']==2): ?> checked <?php endif; ?> id="radio-1" name="status">
						<label for="radio-1">不开启</label>
					</div>
					<div class="radio-box">
						<input type="radio" value="1" <?php if($info1['status']==1): ?> checked <?php endif; ?> id="radio-2" name="status">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info1['ali_id']; ?>" placeholder="阿里云AccessKeyId" class="input-text" id="ali_id">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云AccessKeySecret:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info1['ali_token']; ?>" placeholder="阿里云AccessKeySecret" class="input-text" id="ali_token">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云短信签名 :</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info1['ali_name']; ?>" placeholder="阿里云短信签名" class="input-text" id="ali_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云短信模板Id :</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info1['ali_code']; ?>" placeholder="阿里云短信模板Id" class="input-text" id="ali_code"><br>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info1['phone']; ?>" class="input-text" placeholder="接收人电话,多个请用英文逗号隔开" id="phone">
			</div>
		</div>
		<?php if($info1['ok_use']>0): ?>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">已使用量:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo $info1['ok_use']; ?>" class="input-text" disabled>
			</div>
		</div>
		<?php endif; ?>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input class="btn btn-primary radius" onclick="addSuppAjax(1)" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
				<input type="hidden" id="id" value="<?php echo (isset($info1['id']) && ($info1['id'] !== '')?$info1['id']:''); ?>">
				<input class="btn btn-primary radius" onclick="test_sms(1)" type="button" value="&nbsp;&nbsp;测试&nbsp;&nbsp;">
			</div>
		</div>
	</form>
	<span>付款成功通知</span>
	<form action="" method="post" class="form form-horizontal" id="">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="skin-minimal">
					<div class="radio-box" style="padding-left:0;">
						<input type="radio" value="2" <?php if(!empty($info2) && $info2['status']==2): ?> checked <?php endif; ?> id="radio-3" name="status2">
						<label for="radio-3">不开启</label>
					</div>
					<div class="radio-box">
						<input type="radio" value="1" <?php if(!empty($info2) && $info2['status']==1): ?> checked <?php endif; ?> id="radio-4" name="status2">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云AccessKeyId :</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo (isset($info2['ali_id']) && ($info2['ali_id'] !== '')?$info2['ali_id']:''); ?>" placeholder="阿里云AccessKeyId" class="input-text" id="ali_id2">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云AccessKeySecret:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo (isset($info2['ali_token']) && ($info2['ali_token'] !== '')?$info2['ali_token']:''); ?>" placeholder="阿里云AccessKeySecret" class="input-text" id="ali_token2">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云短信签名 :</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo (isset($info2['ali_name']) && ($info2['ali_name'] !== '')?$info2['ali_name']:''); ?>" placeholder="阿里云短信签名" class="input-text" id="ali_name2">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>阿里云短信模板Id :</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo (isset($info2['ali_code']) && ($info2['ali_code'] !== '')?$info2['ali_code']:''); ?>" placeholder="阿里云短信模板Id" class="input-text" id="ali_code2"><br>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>接收人电话:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo (isset($info2['phone']) && ($info2['phone'] !== '')?$info2['phone']:''); ?>" class="input-text" placeholder="接收人电话,多个请用英文逗号隔开" id="phone2">
			</div>
		</div>
		<?php if($info2['ok_use']>0): ?>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">已使用量:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" autocomplete="off" value="<?php echo (isset($info2['ok_use']) && ($info2['ok_use'] !== '')?$info2['ok_use']:0); ?>" class="input-text" disabled>
			</div>
		</div>
		<?php endif; ?>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<input type="hidden" id="id2" value="<?php echo (isset($info2['id']) && ($info2['id'] !== '')?$info2['id']:''); ?>">
...
<script type="text/javascript">
    function addSuppAjax(t) {
        ...
        $.ajax({
            ...
            url:"<?php echo url('config/send_sms'); ?>",
    ...
    function test_sms(t) {
        ...
        layer.confirm("多个手机号将只发送第一个手机号,发送变量为ABCDEF",function () {
            $.ajax({
                ...
                url:"<?php echo url('config/test_sms'); ?>",
                success:function (res) {
                    if(res["Code"]=="OK"){
