<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/config\wx_upload.html";i:1541418044;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1541418050;}*/ ?>
<!DOCTYPE html>
...
<article class="cl pd-20">
    <div id="tab_demo" class="HuiTab" style="margin-bottom: 15px; position:relative;">
        <div class="tabBar clearfix">
            ...
            <span onclick="window.location.href='__CONF_SITE__admin/config/wx_xiao_logs&type=1'">操作日志</span>
        </div>
    </div>
    <div class="form form-horizontal">
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-0" style="display: flex; justify-content: center; align-items: center; width: 100%;">
                <iframe style="width: 100%; height: 840px;" frameborder="0" src="https://vip.ly100.wang/admin/login/wx_tijiao?bus_id=<?php echo $user_info['id']; ?>&app_id=<?php echo $wxappinfo['key']; ?>&app_secret=<?php echo $wxappinfo['secret']; ?>&app_url=<?php echo $un_url; ?>"></iframe>
            </div>
        </div>
    </div>
