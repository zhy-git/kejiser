<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/images\images_select.html";i:1541410608;}*/ ?>
<html>
<head>
...
<script type="text/javascript">
    ...
    function LoadingInfo(page_index) {
        ...
        $.ajax({
            type : "post",
            url : "<?php echo url('images/albumpicturelist'); ?>",
            data : {
                "group_id" : group_id
            },
            dataType: 'json',
    ...
    function getAlbumClassALL() {
        $.ajax({
            type : "post",
            url : "<?php echo url('images/getalbumclassall'); ?>",
            async : false,
            dataType: 'json',
            success : function(data) {
                var html = '';
