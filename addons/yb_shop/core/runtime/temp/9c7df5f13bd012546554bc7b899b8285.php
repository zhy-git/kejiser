<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/user\level.html";i:1537249572;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    ...
    <article class="cl pd-20">
        ...
        <div class="n_tab_line">
            ...
            <a href="" class="n_tab_list">等级列表</a>

            <div class="l n_tab_add" style="width: auto">
                <button type="button"  class="btn btn-search radius"
                        onclick="level_add('添加会员等级','<?php echo url('user/add_level'); ?>','650px','500px')">
                    <i class="Hui-iconfont">&#xe600;</i> 添加等级
                </button>
            </div>
        </div>
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                ...
                <td><?php echo $vo['hierarchy']; ?></td>
                <th><?php echo (isset($vo['rebate']) && ($vo['rebate'] !== '')?$vo['rebate']:"10"); ?>折</th>
                <td>
                    <a title="编辑" href="javascript:;" onclick="level_edit('编辑会员等级','<?php echo url('user/edit_level'); ?>&id=<?php echo $vo['id']; ?>','650px','500px')" class="ml-5" style="text-decoration:none">编辑</a>
                    <a title="删除" href="javascript:;" onclick="level_del('<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none">删除</a>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    function level_del(id) {
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type : "post",
                url : "<?php echo url('user/level_del'); ?>",
                data: {id: id},
