<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/sappl\applink.html";i:1537249583;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="l n_tab_add"><a href="javascript:;" onclick="add_attr_mod('添加内嵌网页','__CONF_SITE__admin/sappl/applink_add','600','300')"><i class="Hui-iconfont">&#xe600;</i>添加内嵌网页</a></div>

                        </div>

                    </div>
<div class="cl pd-5 bg-1 bk-gray mt-20">
        <form class="Huiform" method="post" action="__CONF_SITE__admin/Sappl/applink" style=" padding: 15px;">

            <div class="text-c"> 网页名称：

               <input type="text" class="input-text" value="<?php echo $name; ?>" style="width:250px" placeholder="网页名称"  name="name">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tr class="text-c">
                ...
                <td>
                    ...
                    <a title="编辑" href="javascript:;" onclick="attr_mod_edit('编辑','__CONF_SITE__admin/Sappl/applink_edit&id=<?php echo $vo['id']; ?>','600','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="attr_mod_del(this,'<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
    ...
    function attr_mod_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                ...
                url : "<?php echo url('Sappl/applink_del'); ?>",
