<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/activity\index.html";i:1537249728;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1537407274;}*/ ?>
<!DOCTYPE html>
...
<div class="Hui-article">
    <article class="cl pd-20">
        <div class="n_tab_line">
            <a href="<?php echo url('activity/index'); ?>" class="n_tab_list">满减活动</a>
            <a href="javascript:;" onclick="activity_add('添加满减条件','__CONF_SITE__admin/Activity/addActivity','600','400')" class="n_tab_add"><i class="Hui-iconfont">&#xe600;</i>添加活动</a>
            <div class="cl"></div>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <form class="Huiform" method="post" action="__CONF_SITE__admin/activity/index" target="_self" style="padding:15px;">
        ...
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a style="text-decoration:none;color:#0066cc;" title="编辑" href="javascript:;" onclick="activity_edit('活动编辑','__CONF_SITE__admin/Activity/editActivity&id=<?php echo $vo['id']; ?>','600','400')" class="ml-5" style="text-decoration:none">编辑
<!--                    <i class="Hui-iconfont">&#xe6df;</i>-->
                    </a>
                    <!--<a title="删除" href="javascript:;" onclick="activity_del(this,'<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>-->
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    function activity_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo url('activity/delActivity'); ?>",
                data : {
                    "id" : id,
                },
    ...
    function activity_stop(obj,id){
        layer.confirm('确认要停用吗？',function(index){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo url('Activity/offActivity'); ?>",
                data : {
                    "id" : id,
                },
                success : function(data) {
    ...
    function activity_start(obj,id){
        layer.confirm('确认要启用吗？',function(index){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo url('Activity/onActivity'); ?>",
                data : {
                    "id" : id,
                },
                success : function(data) {
