<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/menu\import_mod.html";i:1541417985;s:68:"D:\Hostweb\wbwx.xcweibao.com\addons\yb_shop\core\/template/base.html";i:1541418050;}*/ ?>
<!DOCTYPE html>
...
<div id="tab_demo" class="HuiTab" style="margin-bottom: 15px; position:relative;margin-left: 10px; margin-top: 20px;z-index: 9999999;">
    <div class="tabBar clearfix">
        <span <?php if($status==0): ?> class="current" <?php else: ?> onclick="window.location.href = '__CONF_SITE__admin/menu/import_mod&status=0'" <?php endif; ?>>全部</span>
            ...
            <dl>
                ...
                <div class="float_btn">
                    ...
                    <dd style="position: absolute;top:170px; text-align: center;">
                        <?php if($m['is_dow']==1): ?>
                        <button onclick="this_mod('<?php echo $m['serve_temp_id']; ?>','<?php echo $m['id']; ?>')" class="btn btn-success radius" style="z-index:1000;padding: 10px 20px;">选择模版</button><p></p>
                            <?php if($isfounder==1): ?>
                            <button onclick="update_this_mod('<?php echo $m['serve_temp_id']; ?>','<?php echo $m['id']; ?>')" class="btn btn-warning" style="background-color:#f0ad4e;z-index:1000;padding: 10px 20px;">更新模版</button><p></p>
                            <?php endif; endif; if($m['is_dow']==0): ?>
