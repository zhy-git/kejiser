        ...
        for (var m = 0; m < $specObj[i]["value"].length; m++) {
            ...
            if (selected_obj.data("spec-show-type") == 2) {
                ...
                if (src == "" || src == undefined) {
                    src = host + "addons/yb_shop/core/index.php?s=/public/admin/images/goods/goods_sku_add.png";
                }
...
function createSkuPictureBox(spec_id, spec_value_id, spec_name, spec_value_name) {
    ...
    if (sku_picture !== "") {
        ...
        html += '<img src="' + host + 'addons/yb_shop/core/public/goods/img/default_goods_image_240.gif">';
        html += '</div>';
    }
    html += '</div>';
