<?php 
	...
	if( $_GPC['op'] == 'list' ) {
		...
		$info = Util::getAllDataInSingleTable('zofui_sitetemp_article',$where,$_GPC['page'],10,' `number` DESC,`id` DESC ',true,false,' id,img,title,time,type,url ');
		$list = $info[0];
