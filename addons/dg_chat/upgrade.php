...
if(!pdo_fieldexists("wx_school_allcamera", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_allcamera")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_area", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_area")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_area", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_area")." ADD 0为第一级';");
}
...
if(!pdo_fieldexists("wx_school_banners", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_banners")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_banners", "leixing")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_banners")." ADD 
  `leixing` int(1) NOT NULL DEFAULT '0' COMMENT '0学校;");
}
if(!pdo_fieldexists("wx_school_banners", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_banners")." ADD 1平台';");
}
...
if(!pdo_fieldexists("wx_school_bjq", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_bjq")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_camerapl", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_camerapl")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_checklog", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checklog")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_checklog", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checklog")." ADD 10) NOT NULL DEFAULT '0.0000000000' COMMENT '经度';");
}
...
if(!pdo_fieldexists("wx_school_checklog", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checklog")." ADD 10) NOT NULL DEFAULT '0.0000000000' COMMENT '纬度';");
}
...
if(!pdo_fieldexists("wx_school_checkmac", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_checkmac")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_classify", "sid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD 
  `sid` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_classify", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_classify")." ADD 0为第一级';");
}
if(!pdo_fieldexists("wx_school_cookbook", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cookbook")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_cookbook", "ishow")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cookbook")." ADD 
  `ishow` int(1) NOT NULL DEFAULT '1' COMMENT '1:显示;");
}
if(!pdo_fieldexists("wx_school_cookbook", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cookbook")." ADD 2隐藏;");
}
if(!pdo_fieldexists("wx_school_cookbook", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cookbook")." ADD 默认1';");
}
...
if(!pdo_fieldexists("wx_school_cost", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cost")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_cost", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_cost")." ADD 2) NOT NULL DEFAULT '0.00';");
}
...
if(!pdo_fieldexists("wx_school_coursetable", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_coursetable")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_coursetable", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_coursetable")." ADD 2隐藏;");
}
if(!pdo_fieldexists("wx_school_coursetable", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_coursetable")." ADD 默认1';");
}
...
if(!pdo_fieldexists("wx_school_dianzan", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_dianzan")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_email", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_email")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_fans_group", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_fans_group")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_icon", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_icon")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_idcard", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_idcard", "is_on")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD 
  `is_on` int(1) NOT NULL DEFAULT '0' COMMENT '1:使用;");
}
if(!pdo_fieldexists("wx_school_idcard", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD 2未用;");
}
if(!pdo_fieldexists("wx_school_idcard", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD 默认0';");
}
if(!pdo_fieldexists("wx_school_idcard", "usertype")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD 
  `usertype` int(1) NOT NULL DEFAULT '0' COMMENT '1:老师;");
}
if(!pdo_fieldexists("wx_school_idcard", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_idcard")." ADD 学生0';");
}
if(!pdo_fieldexists("wx_school_index", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_index", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD 10) NOT NULL DEFAULT '0.0000000000' COMMENT '经度';");
}
...
if(!pdo_fieldexists("wx_school_index", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_index")." ADD 10) NOT NULL DEFAULT '0.0000000000' COMMENT '纬度';");
}
...
if(!pdo_fieldexists("wx_school_kcbiao", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_kcbiao")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_leave", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_leave")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_media", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_media")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_news", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_news")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_notice", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_notice")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_object", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_object")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_order", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_order", "lastorderid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD 
  `lastorderid` int(10) unsigned NOT NULL COMMENT '继承订单;");
}
if(!pdo_fieldexists("wx_school_order", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD 用于续费';");
}
...
if(!pdo_fieldexists("wx_school_order", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_order")." ADD 2) NOT NULL DEFAULT '0.00';");
}
...
if(!pdo_fieldexists("wx_school_qrcode_info", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qrcode_info")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_qrcode_info", "idx_qrcid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qrcode_info")." ADD 
  KEY `idx_qrcid` (`qrcid`)
;");
}
if(!pdo_fieldexists("wx_school_qrcode_set", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qrcode_set")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_qrcode_statinfo", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_qrcode_statinfo")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_record", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_record")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_reply", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_reply")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_reply", "idx_rid")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_reply")." ADD 
  KEY `idx_rid` (`rid`)
;");
}
if(!pdo_fieldexists("wx_school_scforxs", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_scforxs")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_score", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_score")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_set", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_set")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_shouce", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_shouce")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_shoucepyk", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_shoucepyk")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_shouceset", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_shouceset")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_shouceseticon", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_shouceseticon")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_signup", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_signup")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_students", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_students")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD 2) NOT NULL DEFAULT '0.00' COMMENT '报名费用';");
}
...
if(!pdo_fieldexists("wx_school_tcourse", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_tcourse")." ADD 2否';");
}
...
if(!pdo_fieldexists("wx_school_teachers", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_teachers")." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_type", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_type")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_type", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_type")." ADD 0为第一级';");
}
...
if(!pdo_fieldexists("wx_school_user", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_user")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_wxpay", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_wxpay")." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_wxpay", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_wxpay")." ADD 2) NOT NULL DEFAULT '0.00';");
}
...
if(!pdo_fieldexists("wx_school_zjh", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_zjh")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_zjhdetail", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_zjhdetail")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_zjhset", "id")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_zjhset")." ADD 
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists("wx_school_zjhset", "type")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_zjhset")." ADD 
  `type` varchar(2) DEFAULT '' COMMENT 'AM;");
}
if(!pdo_fieldexists("wx_school_zjhset", "")) {
 pdo_query("ALTER TABLE ".tablename("wx_school_zjhset")." ADD PM';");
}
