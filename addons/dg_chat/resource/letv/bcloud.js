...
! (function(document, undefined) {
	...
	SOTool = {
		...
		setPluginStack: function(a, b) {
			if (videoSdkTool.isArray(a)) for (var d = 0; d < a.length; d++) arguments.callee(a[d], b);
	...
	var DomainTool = function() {
		...
		function b(a, b) {
			...
			if (window && "https:" == window.location.protocol || "undefined" != typeof b && b) {
				if ( - 1 != a.indexOf("http://")) return d = a.split("://")[1],
		...
		return {
			getDomain: function(c, d, f) {
				var h = c; - 1 != c.indexOf("://") && (h = c.match(/^http(|s):\/\/[a-zA-Z\.0-9:]*/)[0], h = c.replace(h, b(a(h, d), f)));
				return h
			}
		}
	} ();
	...
	var LangTool = function() {
		...
		return {
			...
			toMessage: function(d, c, g) {
				if (a) return b.hasOwnProperty(g) ? {
					message: b[g]
				}: {
					message: g
				};
				SOTool.getPlugin("lang.message.plugin." + c,
				function(c) {
					c && (b = c, a = !0);
					d()
				});
			...
			toMessageN: function(d, c, g) {
				if (a) return b.hasOwnProperty(g.message) ? {
					message: b[g.message]
				}: "490" == g.code ? {
					message: g.message
				}: {
	...
	var videoSdkTool = function() {
		...
		function b(a) {
			...
			if (b) {
				...
				if ( - 1 < a.indexOf("windows nt 5.1") || -1 < a.indexOf("windows XP")) return "winXP";
		...
		return {
			...
			getJSON: function(a, b, c, d, k, l) {
				...
				var z = function() {
					clearTimeout(q);
					r && r.parentNode && (w.removeChild(r), r.onload = r.onreadystatechange = null, r.onerror = null, r = void 0)
				},
				D = function() {
					z();
			...
			objectParseToString: function(a) {
				...
				c = 0,
				d;
				for (d in a) b = 0 < c ? b + ("&" + d + "=" + a[d]) : b + (d + "=" + a[d]),
				c++;
				return b
			},
			...
			clone: function(a) {
				...
				if (a instanceof Array) for (b = [], c = 0, d = a.length; c < d; c++) b[c] = "object" == typeof a[c] && null != a[c] ? arguments.callee(a[c]) : a[c];
				else for (c in b = {},
				a) b[c] = "object" == typeof a[c] && null != a[c] ? arguments.callee(a[c]) : a[c];
				return b
			},
			isHttps: function() {
				try {
	...
	BaseCode = {
		decode: function(a) {
			...
			if (!a) return a;
			a += "";
			do b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)),
	...
	MD5 = function() {
		...
		return {
			hash: function(e) {
				for (var f = [], h = 0; h < 8 * e.length; h += 8) f[h >> 5] |= (e.charCodeAt(h / 8) & 255) << h % 32;
				e = 8 * e.length;
				f[e >> 5] |= 128 << e % 32;
				f[(e + 64 >>> 9 << 4) + 14] = e;
				e = 1732584193;
				...
				f = [e, h, k, l];
				e = "";
				for (h = 0; h < 4 * f.length; h++) e += "0123456789abcdef".charAt(f[h >> 2] >> h % 4 * 8 + 4 & 15) + "0123456789abcdef".charAt(f[h >> 2] >> h % 4 * 8 & 15);
				return e
			}
		}
	} (),
	UiTool = {
		...
		getMousePoint: function(a) {
			...
			g = document.body;
			a || (a = window.event);
			window.pageYOffset ? (d = window.pageXOffset, y = window.pageYOffset) : (d = (c && c.scrollLeft || g && g.scrollLeft || 0) - (c && c.clientLeft || g && g.clientLeft || 0), y = (c && c.scrollTop || g && g.scrollTop || 0) - (c && c.clientTop || g && g.clientTop || 0));
		...
		drag: function(a, b) {
			...
			a["on" + c] = function(c) {
				...
				function l(c) {
					...
					h = u.x + h;
					k = u.x + k;
					q && (h < q.x ? h = q.x: h > q.x + q.w && (h = q.x + q.w), k < q.y ? k = q.y: k > q.y + 0 + q.h && (k = q.y + q.h));
					a.style.left = h + "px";
					a.style.top = k + "px";
				...
				c || (c = window.event);
				c.preventDefault();
				d ? (c = c.touches.item(0), s = c.pageX, t = c.pageY) : (s = c.clientX + n.body.scrollLeft, t = c.clientY + n.body.scrollTop);
				var u = {
		...
		hexToRgba: function(a, b) {
			...
			if (d && c.test(d)) {
				if (4 === d.length) {
					for (var g = "#",
					c = 1; 4 > c; c += 1) g += d.slice(c, c + 1).concat(d.slice(c, c + 1));
					d = g
				}
				g = [];
	...
	FlashPlayer = {
		...
		create: function(a, b, d) {
			...
			if (this.check(g.version)) {
				if (this.isEmdbed) for (e in d = ["<embed name='" + c + "'src='" + g.url + "' pluginspage='http://www.macromedia.com/go/getflashplayer' type='application/x-shockwave-flash' width='" + g.width + "' height='" + g.height + "' ", " />"], b = "", g)"width" != e && "height" != e && "url" != e && (b += e + "='" + g[e] + "' ");
				else for (e in b = "", d = ["<object id='" + c + "' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,45,0' type='application/x-shockwave-flash' width='" + g.width + "' height='" + g.height + "'><param name='movie' value='" + g.url + "'/>", "</object>"], g)"width" != e && "height" != e && "url" != e && (b += "<param name='" + e + "' value='" + g[e] + "'/>");
				b = d.join(b)
		...
		return {
			...
			importClass: function(b) {
				for (var d = b.split("."), c = a, g = 0; g < d.length - 1; g++) {
					var e = d[g];
					if (!c.hasOwnProperty(e)) throw "the " + b + "--" + e + " class is not provide";
					c = c[e]
				}
				return c
			}
	...
	function() {
		...
		a.prototype.setColor = function(a, c, g, e) {
			...
			var f = this.managerDsipayList.indexOf(a); - 1 == f ? (this.managerDsipayList.push(a), this.cList.push({
				display: a,
				key: c,
				type: g,
				alpha: e
			})) : (this.cList[f].key = c, this.cList[f].type = g, this.cList[f].alpha = e)
		};
	...
	var DisplayObject = function() {
		...
		a.prototype.render = function(a) {
			if (this.el.hasAttribute("render-data")) {
				...
				switch (b[0]) {
				case "canvas":
					if ("img" == d) if (this.renderCanvas) this.el.hasOwnProperty("renderOption") ? this.el.renderOption = a: c.setCanvasColor(this.renderCanvas, a.color);
					else {
	...
	var DragBar = function() {
		...
		a.prototype.addEvents = function(a, b, d) {
			...
			this.view.el.sliderOver.drag({
				rect: function() { (!f.rect.w || 0 >= f.rect.w) && f.reSetRect();
					return f.rect
				},
				onDown: function(a) {
					f.isSeeking = !0
	...
	var SkinRender = {
		...
		getSkinTpl: function(a, b, d, c) {
			if ("" == SkinRender.SkinTpl) {
				...
				b = b.replace(/{#}/g, g);
				UiTool.loadCss(b);
				for (var e in a) for (a[e] = a[e].replace(/{#}/g, g), b = a[e].match(/{[a-z_A-Z0-9]{1,}\.[a-z_A-Z0-9]{1,}}/g) || [], d = 0; d < b.length; d++) {
		...
		a.prototype.loadCmp = function(a, g) {
			if (!this.isClose) {
				...
				if (0 == a.code) {
					...
					e.playerConfig.refresh(f); ! e.outConfig.hasOwnProperty("nskin") && a.playerinfo.hasOwnProperty("nskin") && (e.config.nskin = a.playerinfo.nskin);
					for (var k in a.playerinfo.onoff) h.hasOwnProperty(k) && (a.playerinfo.onoff[h[k]] = a.playerinfo.onoff[k], delete a.playerinfo.onoff[k], k = h[k]),
					...
					for (var h = {},
					l = 0; l < a.videoinfo.medialist.length; l++) {
	...
	CloudMmsProxy = function() {
		...
		ClassTool.inherits(a, Proxy);
		a.prototype.getRequestList = function() {
			for (var a = [], d = [], e = DomainTool.getDomain("http://api.mms.lecloud.com/v2/mms/play", this.model.config.lang), f = "cf uu vu format callback pageurl pver ran ver p pu pet userId utoken".split(" "), h = {},
			k = 0; k < f.length; k++) {
				var l = f[k];
		...
		a.prototype.loadCmp = function(a, g) {
			if (!this.isClose) {
				...
				if (0 == a.code) {
					...
					h;
					for (h in a.playerinfo.onoff) f.hasOwnProperty(h) && (a.playerinfo.onoff[f[h]] = a.playerinfo.onoff[h], delete a.playerinfo.onoff[h], h = f[h]),
					...
					f.defaultDefinition = a.videoinfo.medialist[0].vtype;
					f.isdrm = a.videoinfo.isdrm;
					if (a.videoinfo.hasOwnProperty("ark")) f.ark = a.videoinfo.ark;
					...
					a.videoinfo.hasOwnProperty("businessline") && (f.p = a.videoinfo.businessline);
					for (var l = {},
					k = 0; k < a.videoinfo.medialist.length; k++) {
	...
	Reporter = function() {
		...
		b.prototype = {
			...
			sendPlayStat: function(a, b) {
				...
				if ("html5" == this.model.platform || "wx" == this.model.platform) c += "&lc=" + this.checkValue(k.lc()),
			...
			sendErrorStat: function(a) {
				...
				if ("html5" == this.model.platform || "wx" == this.model.platform) b += "&lc=" + this.checkValue(c.lc()),
				...
				"vod" == c.playType && (b += "&cid=" + this.checkValue(c.videoSetting.cid), "" != c.videoSetting.pid && (b += "&pid=" + this.checkValue(c.videoSetting.pid)), b += "&vid=" + this.checkValue(c.videoSetting.vid));
				a = {
	...
	ModelHandler = function() {
		...
		a.prototype.setUp = function(a, d) {
			if (this.model.config.hasOwnProperty("url")) {
				...
				c.load()
			} else a.hasOwnProperty("uu") && a.hasOwnProperty("vu") && a.uu && a.vu ? (this.model.vodPlayType = GlobalHandler.checkPlayType(), this.vodproxy = "101" == this.model.videoSetting.p ? new CloudVodProxy(this.model) : new CloudMmsProxy(this.model), this.vodproxy.addEventListener(LoadEvent.LOADCMP, this.gpcCmp, this), this.vodproxy.addEventListener(LoadEvent.LOADERROR, this.errorHanlder, this), this.vodproxy.load()) : this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{
				code: ERR.PARAMS
			}]))
		};
	...
	H5SamplePlayer = function() {
		...
		a.prototype.addEvents = function() {
			...
			b = 0; b < d.length; b++) a.addEventListener(d[b], this.videoHandlerBack, !0)
		};
		a.prototype.removeEvents = function() {
			for (var a = this.video,
			b = 0; b < d.length; b++) a.removeEventListener(d[b], this.videoHandlerBack, !0)
		};
		...
		a.prototype.prePlay = function(a, b, d) {
			...
			f.stream.init({
				...
				onstart: function() {
					...
					f.addEvents();
					f.video.src = f.url;
					if (f.autoplay || play) f.video.load && f.video.load(),
					f.resume(d.callback)
				},
				onerror: function(h) {
					"flv" == h.message ? (d.useFlv = !1, f.stream.close(), f.prePlay(a, b, d)) : (f.log("\u64ad\u653e\u5f15\u64ce\u521d\u59cb\u5316\u5931\u8d25"), h.retryCdn = !1, f.errorHandler(h))
				}
			})
		};
	...
	function() {
		...
		a.prototype.setUp = function(a) {
			...
			this._index = 0;
			var c = this;
			if (this.waterData) for (a = 0; a < this.waterData.length; a++) d = UiTool.$C("img"),
			d.num = a,
			this.waterData[a].hasOwnProperty("position") && this.waterData[a].hasOwnProperty("url") && (this.waterData[a].hasOwnProperty("x") || (this.waterData[a].x = 15), this.waterData[a].hasOwnProperty("y") || (this.waterData[a].y = 15), this.waterData[a].hasOwnProperty("width") || (this.waterData[a].width = 640), this.waterData[a].hasOwnProperty("height") || (this.waterData[a].height = 360), d.onload = function() {
		...
		a.prototype._renderWater = function(a, d) {
			...
			if (e.hasMetadata) {
				...
				h = 1;
				else f = e.width / this.model.videoSetting.videoOrgWidth,
	...
	AdCtrl = function() {
		...
		b.prototype.initAd = function(b, c) {
			...
			"undefined" != typeof e.H5AD && "function" == typeof e.H5AD.initAD && (f = new a, f.p1 = this.model.reportParam.p1, f.p2 = this.model.reportParam.p2, f.p3 = this.model.reportParam.p2, f.lc = this.model.lc(), f.uuid = this.model.uuid(), f.ver = this.model.playerConfig.version, f.gdur = this.model.videoSetting.duration, f.cont = this.videoOutEl.id, "vod" == this.model.playType ? (f.islive = !1, f.cid = this.model.videoSetting.cid, f.vid = this.model.videoSetting.vid, f.mmsid = this.model.videoSetting.mmsid, this.model.videoSetting.hasOwnProperty("pid") && (f.pid = this.model.videoSetting.pid)) : "live" == this.model.playType && (f.islive = !0, f.sid = this.model.config.activityId), f.ch = this.model.getTypeFrom(), f.ark = this.model.videoSetting.ark, f.useui = 1, this.model.videoSetting.hasOwnProperty("p") && (f.ext = "" == this.model.userData.userId ? this.model.videoSetting.p: this.model.videoSetting.p + "|" + this.model.userData.userId), 530 > this.videoOutEl.clientWidth && (f.pname = "MPlayer"), e.model.videoSetting.hasOwnProperty("sspAd") && (f.sspid = this.model.videoSetting.sspAd.sspId, f.slotid = this.model.videoSetting.sspAd.preSlotId, f.playid = this.model.uuid() + "_" + videoSdkTool.now(), f.playInline = 1), e.H5AD.initAD(f, g))
		};
	...
	GlobalPlayer = function() {
		...
		a.prototype.addEvents = function() {
			...
			var d; ["webkit", "moz", "o", "ms"].forEach(function(a) {
				"undefined" != typeof document[a + "Hidden"] && (d = a)
			});
			UiTool.addEvent(document, d + "visibilitychange",
			function() {
		...
		a.prototype.addVideoEvents = function(a) {
			...
			var d = this;
			d.addVideoEvent || (a.addEventListener("webkitbeginfullscreen",
			function() {
	...
	ErrorPlayer = function() {
		...
		a.prototype.show = function(a) {
			...
			function(c) {
				c && (d.error = new c, d.error.show(a, d.el, {
					api: d._api,
					model: d.model
				}))
			})
	...
	H5Sdk = function() {
		...
		a.prototype.getVideoSetting = function() {
			for (var a = videoSdkTool.clone(this._pl.model.videoSetting), d = {},
			c = 0; c < GlobalHandler.settingList().length; c++) {
	...
	BaseH5Player = function() {
		...
		a.prototype.setPlayerInfo = function(a) {
			...
			for (c in a) d.hasOwnProperty(c) && (a[d[c]] = a[c], delete a[c]),
