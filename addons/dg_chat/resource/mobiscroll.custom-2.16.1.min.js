...
if (!window.jQuery) {
	...
	(function(a) {
		...
		a.fn.prevUntil = function(m) {
			for (var c = this, l = []; c.length && !a(c).filter(m).length;) l.push(c[0]), c = c.prev();
			return a(l)
		};
		a.fn.nextUntil = function(m) {
			for (var c = this, l = []; c.length && !c.filter(m).length;) l.push(c[0]), c = c.next();
			return a(l)
		};
		a._extend = a.extend;
		a.extend = function() {
...
(function(a, m) {
	...
	function l(c, f, e) {
		var i = c;
		if ("object" === typeof f) return c.each(function() {
		...
		"string" === typeof f && c.each(function() {
			var a;
			if ((a = v[this.id]) && a[f])
				if (a = a[f].apply(this, Array.prototype.slice.call(e, 1)), a !== m) return i = a, !1
		});
		return i
	}
	...
	w = a.mobiscroll = a.mobiscroll || {
		...
		util: {
			...
			has3d: i,
			hasFlex: f,
			testTouch: function(c, f) {
				if ("touchstart" == c.type) a(f).attr("data-touch", "1");
				else if (a(f).attr("data-touch")) return a(f).removeAttr("data-touch"), !1;
				return !0
			},
			...
			arrayToObject: function(a) {
				var c = {},
					f;
				if (a)
					for (f = 0; f < a.length; f++) c[a[f]] = a[f];
				return c
			},
	...
	a.mobiscroll.classes.Base = function(c, f) {
		var e, i, l, m, x, R, w = a.mobiscroll,
			y = this;
		y.settings = {};
...
(function(a, m, c, l) {
	...
	s.classes.Frame = function(v, da, ca) {
		...
		var T, G, ra, z, fa, Y, E, r, W, g, P, F, J, q, D, K, p, B, H, o, b, n, V, Z, d = this,
			O = a(v),
			U = [],
			N = {};
		s.classes.Base.call(this, v, da, !0);
		d.position = function(g) {
			var e, i, k, n, m, u, C, v, h, $, wa = 0,
				Da = 0;
			h = {};
			...
			if (!(V === q && Z === Q && g || H))
				if ((d._isFullScreen ||
						/top|bottom/.test(o.display)) && E.width(q), !1 !== J("onPosition", [z, q, Q]) && D) {
					i = r.scrollLeft();
					g = r.scrollTop();
		...
		d.show = function(c, f) {
			...
			if (!o.disabled && !d._isVisible) {
				...
				e = '<div lang="' + o.lang + '" class="mbsc-' + o.theme + (o.baseTheme ? " mbsc-" + o.baseTheme : "") + " dw-" + o.display + " " + (o.cssClass || "") + (d._isLiquid ? " dw-liq" : "") + (qa ? " mbsc-old" : "") + (q ? "" : " dw-nobtn") + '"><div class="dw-persp">' + (D ? '<div class="dwo"></div>' : "") + "<div" + (D ? ' role="dialog" tabindex="-1"' :
					"") + ' class="dw' + (o.rtl ? " dw-rtl" : " dw-ltr") + '">' + ("bubble" === o.display ? '<div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div>' : "") + '<div class="dwwr"><div aria-live="assertive" class="dw-aria dw-hidden"></div>' + (o.headerText ? '<div class="dwv">' + (ka(o.headerText) ? o.headerText : "") + "</div>" : "") + '<div class="dwcc">';
				...
				D && !F && (f ||
					E.focus(), d.ariaMessage(o.ariaMessage));
		...
		d.hide = function(b, c, f) {
			...
			if (z) {
				...
				if (I && D && F && !b && !z.hasClass("dw-trans")) z.addClass("dw-out dw-trans").find(".dw").addClass("dw-" + F).on("webkitAnimationEnd animationend",
					function() {
						X(b)
					});
				else X(b);
		...
		d._presetLoad = function(a) {
			...
			a.headerText = a.headerText ===
				l ? "inline" !== a.display ? "{value}" : !1 : a.headerText
		};
...
(function(a, m, c, l) {
	...
	w.Scroller = function(m, ba, ha) {
		function ja(h) {
			if (ka(h, this) && !e && !o && !J && !S(this) && a.mobiscroll.running && (h.preventDefault(), h.stopPropagation(), e = !0, q = "clickpick" != p.mode, N = a(".dw-ul", this), G(N), d = (b = la[M] !== l) ? Math.round(-s.getPosition(N, !0) / D) : u[M], n = i(h, "Y"), V = new Date, Z = n, fa(N, M, d, 0.001), q && N.closest(".dwwl").addClass("dwa"),
					"mousedown" === h.type)) a(c).on("mousemove", da).on("mouseup", ca)
		}
		...
		function ca(h) {
			if (e) {
				...
				if (b) u = f(Math.round(d - $ / D), O, U), $ = i ? Math.max(0.1, Math.abs((u - g) / i) *
					p.timeUnit) : 0.1;
				else {
		...
		function T(h) {
			...
			a.each(g, function(h, g) {
				...
				b += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + f[h] + '"' + (c[h] ? ' aria-label="' + c[h] + '"' :
					"") + ' style="height:' + D + "px;line-height:" + D + 'px;"><div class="dw-i"' + (1 < na ? ' style="line-height:' + Math.round(D / na) + "px;font-size:" + Math.round(0.8 * (D / na)) + 'px;"' : "") + ">" + g + k._processItem(a, 0.2) + "</div></div>";
				d++
			});
			return b += "</div>"
		}
		...
		function Y(b, d, c, g, e) {
			var u = a('.dw-li[data-val="' +
					b + '"]', d),
				i = a(".dw-li", d),
				b = i.index(u),
				k = i.length;
			if (g) G(d);
			else if (!u.hasClass("dw-v")) {
				for (var l = u, n = 0, C = 0; 0 <= b - n && !l.hasClass("dw-v");) n++, l = i.eq(b - n);
				for (; b + C < k && !u.hasClass("dw-v");) C++, u = i.eq(b + C);
			...
			return {
				selected: c,
				v: g ? f(b, O, U) : b,
				val: u.hasClass("dw-v") || g ? u.attr("data-val") : null
			}
		}
		...
		var F, J, q, D, K, p, B, H, o, b, n, V, Z, d, O, U, N, M, na, ia, k = this,
			oa = a(m),
			la = {},
			u = {},
			C = {},
			...
			a.each(p.wheels, function(g, f) {
				...
				a.each(f, function(a, g) {
					...
					d += "<" + (I ? "div" : "td") + ' class="dwfl" style="' + (p.fixedWidth ? "width:" + (p.fixedWidth[c] || p.fixedWidth) + "px;" : (p.minWidth ? "min-width:" + (p.minWidth[c] || p.minWidth) + "px;" : "min-width:" + p.width + "px;") + (p.maxWidth ? "max-width:" + (p.maxWidth[c] || p.maxWidth) + "px;" : "")) + '"><div class="dwwl dwwl' + c + (g.multiple ? " dwwms" : "") + '">' + ("scroller" != p.mode ? '<div class="dwb-e dwwb dwwbp ' + (p.btnPlusClass || "") + '" style="height:' + D + "px;line-height:" + D + 'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm ' + (p.btnMinusClass ||
						"") + '" style="height:' + D + "px;line-height:" + D + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + b + '</div><div tabindex="0" aria-live="off" aria-label="' + b + '" role="listbox" class="dwww"><div class="dww" style="height:' + p.rows * D + 'px;"><div class="dw-ul" style="margin-top:' + (g.multiple ? "scroller" == p.mode ? 0 : D : p.rows / 2 * D - D / 2) + 'px;">';
					d += T(c) + '</div></div><div class="dwwo"></div></div><div class="dwwol"' + (p.selectedLineHeight ? ' style="height:' + D + "px;margin-top:-" + (D / 2 + (p.selectedLineBorder || 0)) +
						'px;"' : "") + "></div></div>" + (I ? "</div>" : "</td>");
					c++
				});
...
(function(a) {
	...
	m.datetime = {
		defaults: {
			...
			getDate: function(a, l, e, m, s, v, L) {
				return new Date(a, l, e, m || 0, s || 0, v || 0, L || 0)
			},
			getMaxDayOfMonth: function(a, l) {
		...
		formatDate: function(c, l, e) {
			if (!l) return null;
			var e = a.extend({}, m.datetime.defaults, e),
				w = function(a) {
					for (var f =
							0; L + 1 < c.length && c.charAt(L + 1) == a;) f++, L++;
					return f
				},
				s = function(a, c, f) {
					c = "" + c;
					if (w(a))
						for (; c.length < f;) c = "0" + c;
					return c
				},
				v = function(a, c, f, e) {
					return w(a) ? e[c] : f[c]
			...
			for (L = 0; L < c.length; L++)
				if (f) "'" == c.charAt(L) && !w("'") ? f = !1 : i += c.charAt(L);
		...
		parseDate: function(c, l, e) {
			...
			for (x = 0; x < c.length; x++)
				if (ha) "'" == c.charAt(x) && !ja("'") ? ha = !1 : ea++;
				else switch (c.charAt(x)) {
					case "d":
						I = da("d");
						break;
					case "D":
			...
			f =
				e.getDate(v, L - 1, I, -1 == ba ? f : ba && 12 > f ? f + 12 : !ba && 12 == f ? 0 : f, ka, qa);
	...
	w.calbase = function(f) {
		function m(b, c, d) {
			...
			b && a.each(b, function(a, b) {
				...
				f = g + "";
				if (b.start && b.end)
					for (e = new Date(b.start); e <= b.end;) h = new Date(e.getFullYear(), e.getMonth(), e.getDate()), u[h] = u[h] || [], u[h].push(b), e.setDate(e.getDate() + 1);
				else if (g.getTime) h = new Date(g.getFullYear(), g.getMonth(), g.getDate()), u[h] = u[h] || [], u[h].push(b);
				else if (f.match(/w/i)) {
					var k = +f.replace("w", ""),
						n = 0,
						C = j.getDate(c, d - ga - pa, 1).getDay();
					1 < j.firstDay - C + 1 && (n = 7);
					for (P = 0; P < 5 * xa; P++) h = j.getDate(c, d - ga - pa, 7 * P - n - C + 1 + k), u[h] = u[h] || [], u[h].push(b)
				} else if (f = f.split("/"), f[1]) 11 <= d + i && (h = j.getDate(c + 1, f[0] - 1, f[1]), u[h] = u[h] || [], u[h].push(b)), 1 >= d - i && (h = j.getDate(c - 1, f[0] - 1, f[1]), u[h] = u[h] || [], u[h].push(b)), h = j.getDate(c, f[0] - 1, f[1]), u[h] = u[h] || [], u[h].push(b);
				else
					for (P = 0; P < xa; P++) h = j.getDate(c, d - ga - pa + P, f[0]), u[h] = u[h] || [], u[h].push(b)
			});
			return u
		}
		...
		function ba(a, b, c,
			...
			for (g = 1; g <= b; g++) e = 12 >= g || g > c ? e + '<div class="dw-cal-sc-m-cell dw-cal-sc-cell dw-cal-sc-empty"><div class="dw-i">&nbsp;</div></div>' : e + ('<div tabindex="0" role="button"' + (h ? ' aria-label="' + h[g - 13] + '"' : "") + ' class="dwb-e dwb-nhl dw-cal-sc-m-cell dw-cal-sc-cell dw-cal-' + a + '-s" data-val=' + (d + g - 13) + '><div class="dw-i dw-cal-sc-tbl"><div class="dw-cal-sc-cell">' +
				(u ? u[g - 13] : d + g - 13 + f) + "</div></div></div>"), g < b && (0 === g % 12 ? e += '</div></div></div><div class="dw-cal-sc-p" style="' + (ya ? "top" : Fa ? "right" : "left") + ":" + 100 * Math.round(g / 12) + '%"><div class="dw-cal-sc-tbl"><div class="dw-cal-sc-row">' : 0 === g % 3 && (e += '</div><div class="dw-cal-sc-row">'));
			return e + "</div></div></div></div></div>"
		}

		function ha(b, c) {
			var d, g, h, u, e, i, k, n, C, $, m, r, v, q, p = 1,
				o = 0;
			d = j.getDate(b, c, 1);
			var V = j.getYear(d),
				s = j.getMonth(d),
			...
			for (q = 0; 42 > q; q++) v = q + j.firstDay - o, d = j.getDate(V, s, v - Z + 1), g = d.getFullYear(), h = d.getMonth(), u = d.getDate(), e = j.getMonth(d), i = j.getDay(d), r = j.getMaxDayOfMonth(g, h), k = g + "-" + h + "-" + u, h = a.extend({
		...
		function ja(b, d, c) {
			...
			if (Ga) {
				...
				Qa = a('.dw-cal-month-s[data-val="' + f + '"]', q).addClass("dw-sel").attr("aria-selected",
					"true");
				...
				if (e === la)
					for (g = 0; g < C; g++) a('.dw-cal-month-s[data-val="' + g + '"]', q).addClass("dwb-d");
				if (e === u)
					for (g = ma + 1; 12 >= g; g++) a('.dw-cal-month-s[data-val="' + g + '"]', q).addClass("dwb-d")
			}
			1 == k.length && k.attr("aria-label", e).html(i);
			for (g = 0; g < A; ++g) f = j.getDate(b, d - pa + g, 1), e = j.getYear(f), f = j.getMonth(f), i = e + Wa, a(na[g]).attr("aria-label", j.monthNames[f] + (Ka ? "" : " " + e)).html((!Ka && oa < ia ?
				i + " " : "") + U[f] + (!Ka && oa > ia ? " " + i : "")), 1 < k.length && a(k[g]).html(i);
		...
		function ea(d, c) {
			if (b && ("calendar" === Aa || c)) {
				...
				c || (f.trigger("onDayHighlight", [d]), j.highlight && (a(".dw-sel .dw-i", K).removeClass(Ha), a(".dw-sel", K).removeClass("dw-sel").removeAttr("aria-selected"),
					a(".dw-cal-week-hl", K).removeClass("dw-cal-week-hl"), (null !== j.defaultValue || f._hasValue) && a('.dw-cal-day[data-full="' + d.getFullYear() + "-" + d.getMonth() + "-" + d.getDate() + '"]', K).addClass("dw-sel").attr("aria-selected", "true").find(".dw-i").addClass(Ha).closest(".dw-cal-row").addClass("dw-cal-week-hl")));
				f.needsSlide = !0
			}
		}
		...
		function x(a, b) {
			qa(a, b);
			for (g = 0; g < xa; g++) sa[g].html(ha(a, b - pa - ga + g));
			X();
			f.needsRefresh = !1
		}
		...
		function R(b, d, c) {
			var f = ga,
				g = ga;
			if (c) {
				for (; g && j.getDate(b, d + f + A - pa - 1, 1) > $;) g--;
				for (; f && j.getDate(b,
						d - g - pa, 1) < h;) f--
			}
			a.extend(N.settings, {
		...
		function y(d, c, h, e, u, i, k) {
			...
			if (!La) {
				...
				qa(d, c);
				if (u)
					for (g = 0; g < A; g++) sa[h ? xa - A + g : g].html(ha(d, c - pa + g));
					...
					N.scroll(H, O ? 200 : 0, function() {
						setTimeout(function() {
							...
							if (sa.length) {
								...
								if (h) {
									j = sa.splice(0, e);
									for (g = 0; g < e; g++) sa.push(j[g]), S(sa[sa.length - 1], +sa[sa.length - 2].data("curr") + 100 * Ma)
								} else {
									j = sa.splice(xa - e, e);
									for (g = e - 1; 0 <= g; g--) sa.unshift(j[g]), S(sa[0], +sa[1].data("curr") - 100 * Ma)
								}
								for (g = 0; g < e; g++) sa[h ? xa - e + g : g].html(ha(d, c - pa - ga + g + (h ? xa - e : 0))), u && sa[h ? g : xa - e + g].html(ha(d, c - pa - ga + g + (h ? 0 : xa - e)));
								for (g = 0; g < A; g++) sa[ga + g].addClass("dw-cal-slide-a").removeAttr("aria-hidden");
								R(d, c, !0);
								La = !1
							}
		...
		function S(a, b) {
			a.data("curr", b);
			v ? a[0].style[L + "Transform"] = "translate3d(" + (ya ? "0," +
				b + "%," : b + "%,0,") + "0)" : a[0].style[ya ? "top" : "left"] = b + "%"
		}
		...
		function z(b) {
			va &&
				j.getDate(Q, aa, 1) >= j.getDate(j.getYear(h) + 1, j.getMonth(h) + pa, 1) && a.mobiscroll.running ? y(--Q, aa, "prev", ga, !0, !0, function() {
					z(b)
		...
		var W, g, P, F, J, q, D, K, p, B, H, o, b, n, V, Z, d, O, U, N, M, na, ia, k, oa, la, u, C, ma, h, $, wa, Da, Ea, Q, aa, Ua, Va, bb, cb, Ja, Aa, La, va, A, xa, Oa, pa, Pa, za, Ia, Qa, fb = this,
			Sa = [],
			sa = [],
			Ra = [],
			ta = {},
		...
		a.extend(F, {
			...
			onMarkupReady: function(i) {
				...
				if (b) {
					A = j.months == "auto" ? Math.max(1, Math.min(3, Math.floor((ib ||
						D[0].innerWidth || D.innerWidth()) / 280))) : j.months;
					xa = A + 2 * ga;
					Oa = Math.floor(A / 2);
					pa = Math.round(A / 2) - 1;
					...
					for (g = 0; g < A; ++g) o = o + ('<div class="dw-cal-btnw-m" style="width: ' + 100 / A + '%"><span role="button" class="dw-cal-month"></span></div>');
					...
					Ka && (w = '<div class="dw-cal-btnw"><div class="' + (Fa ? "dw-cal-next-y" : "dw-cal-prev-y") + ' dw-cal-prev dw-cal-btn dwb dwb-e"><div role="button" tabindex="0" class="dw-cal-btn-txt ' + (j.btnCalPrevClass || "") + '" aria-label="' + j.prevYearText + '"></div></div><span role="button" class="dw-cal-year"></span><div class="' +
						(Fa ? "dw-cal-prev-y" : "dw-cal-next-y") + ' dw-cal-next dw-cal-btn dwb dwb-e"><div role="button" tabindex="0" class="dw-cal-btn-txt ' + (j.btnCalNextClass || "") + '" aria-label="' + j.nextYearText + '"></div></div></div>');
					if (Ga) {
						la = j.getYear(h);
						u = j.getYear($);
						C = j.getMonth(h);
					...
					n = '<div class="mbsc-w-p dw-cal-c"><div class="dw-cal ' + (A > 1 ? " dw-cal-multi " : "") + (Na ? " dw-weeks " : "") +
						(Pa ? "" : " dw-hide-diff ") + (j.calendarClass || "") + '"><div class="dw-cal-header"><div class="dw-cal-btnc ' + (Ka ? "dw-cal-btnc-ym" : "dw-cal-btnc-m") + '">' + (oa < ia || A > 1 ? w + o : o + w) + '</div></div><div class="dw-cal-body"><div class="dw-cal-m-c dw-cal-v"><div class="dw-cal-days-c">';
					for (P = 0; P < A; ++P) {
						n = n + ('<div aria-hidden="true" class="dw-cal-days" style="width: ' + 100 / A + '%"><table cellpadding="0" cellspacing="0"><tr>');
						for (g = 0; g < 7; g++) n = n + ("<th>" + j["dayNames" + kb][(g + j.firstDay) % 7] + "</th>");
						n = n + "</tr></table></div>"
					}
					n =
						n + ('</div><div class="dw-cal-anim-c ' + (j.calendarClass || "") + '"><div class="dw-week-nrs-c ' + (j.weekNrClass || "") + '"><div class="dw-week-nrs"></div></div><div class="dw-cal-anim">');
					for (g = 0; g < A + 2 * ga; g++) n = n + '<div class="dw-cal-slide" aria-hidden="true"></div>';
				...
				if (b) {
					...
					for (g = 0; g < xa; g++) S(sa[g], 100 * (g - ga) * Ma);
					x(Q, aa);
				...
				d = a(".dw-cal-m-c", q);
				if (Ga) {
					d.on("webkitAnimationEnd animationend",
						r);
				...
				setTimeout(function() {
					...
					if (Ga) {
						...
						f.tap(a(".dw-cal-month-s", q), function() {
							!M.scrolled && !a(this).hasClass("dwb-d") && f.navigate(j.getDate(Q, a(this).attr("data-val"),
								1))
						});
			...
			onPosition: function(d, c, h) {
				...
				if (B) {
					...
					if (B !== i) {
						if (Ka) {
							U = j.maxMonthWidth > a(".dw-cal-btnw-m", q).width() ? j.monthNamesShort :
								j.monthNames;
							for (g = 0; g < A; ++g) a(na[g]).text(U[j.getMonth(j.getDate(Q, aa - pa + g, 1))])
						}
						if (Ga) {
			...
			onValidated: function() {
				...
				if (o) a = "calendar";
					...
					for (d in f.order) d && f.order[d] === g && (a = /mdy/.test(d) ? "date" : "time");
				f.trigger("onSetDate", [{
					date: b,
					control: a
				}]);
	...
	l.ScrollView = function(c, e, ea) {
		function x(b) {
			if ((!C.lock || !B) && f(b, this) && !p && a.mobiscroll.running) {
				...
				F = !1;
				G = a(b.target).closest(".mbsc-btn-e",
					this);
		...
		function R(a) {
			if (p) {
				...
				!K && 5 < Math.abs(E) && (k.scrolled = !0, C.liveSwipe && !o && (o = !0,
					H = ha(X)));
		...
		function y(b) {
			if (p) {
				...
				"mouseup" == b.type &&
					a(document).off("mousemove", R).off("mouseup", y);
				p = !1
			}
		}
		...
		function T(a, b, d) {
			...
			B = !0;
			if (L)
				if (N[s + "Transition"] = b ? v + "transform " + Math.round(b) + "ms " + C.easing : "", N[s + "Transform"] = "translate3d(" + (ia ? "0," + a + "px," : a + "px,0,") + "0)", oa == a || !b) c();
				else {
		...
		var G,
			ra, z, fa, Y, E, r, W, g, P, F, J, q, D, K, p, B, H, o, b, n, V, Z, d, O, U, N, M, na, ia, k = this,
			oa = 0,
			la = 0,
			u = 1,
			C = e,
		...
		k.init = function(a) {
			...
			N = M[0].style;
			k.refresh();
			if (C.swipe) ma.on("touchstart mousedown", x).on("touchmove", R).on("touchend touchcancel",
				y);
	...
	var c = a.mobiscroll,
		...
		s = function(e) {
			...
			function ka(a, b) {
				...
				c = d = a;
				if (2 !== b)
					for (e = qa(d); !e && d < N;) d = new Date(d.getTime() + 864E5), e = qa(d), i++;
				if (1 !== b)
					for (g = qa(c); !g && c > U;) c = new Date(c.getTime() - 864E5), g = qa(c), n++;
				return 1 ===
			...
			function ha(a, b, d, c, e, g,
				f) {
				var i, n, k;
				if (a)
					for (i = 0; i < a.length; i++)
						if (n = a[i], k = n + "", !n.start)
							if (n.getTime) r.getYear(n) == b && r.getMonth(n) == d && (g[r.getDay(n) - 1] = f);
							else if (k.match(/w/i)) {
					k = +k.replace("w", "");
					for (S = k - c; S < e; S += 7) 0 <= S && (g[S] = f)
				} else k = k.split("/"), k[1] ? k[0] - 1 == d && (g[k[1] - 1] = f) : g[k[0] - 1] = f
			}

			function ja(c, e, f, h, n, k, l, q, o) {
				var p, s, V, v, t, w, x, y, z, A, B, D, M, G, F, I, L, N, U = {},
					H = {
						h: Z,
						i: d,
						s: O,
				...
				c && (a.each(c, function(a, b) {
					if (b.start && (b.apply = !1, p = b.d, s = p + "", V = s.split("/"), p && (p.getTime &&
							n == r.getYear(p) && k == r.getMonth(p) && l == r.getDay(p) || !s.match(/w/i) && (V[1] && l == V[1] && k == V[0] - 1 || !V[1] && l == V[0]) || s.match(/w/i) && K.getDay() == +s.replace("w", "")))) b.apply = !0, U[K] = !0
					...
					if (c.start && (c.apply || !c.d && !U[K])) {
						v = c.start.split(":");
						t = c.end.split(":");
						for (A = 0; 3 > A; A++) v[A] === m && (v[A] = 0), t[A] === m && (t[A] = 59), v[A] = +v[A], t[A] = +t[A];
						...
						for (A = 0; A < e; A++)
							if (g[A] !== m) {
								y =
									i(v[A], H[J[A]], Y[J[A]], E[J[A]]);
								z = i(t[A], H[J[A]], Y[J[A]], E[J[A]]);
								N = L = I = 0;
						...
						if (!o)
							for (A = e + 1; 4 > A; A++) 0 < v[A] && (M = H[f]), t[A] < E[J[A]] && (G = H[f]);
						F || (y = i(v[e], H[f], Y[f], E[f]) + M, z = i(t[e], H[f], Y[f], E[f]) - G, w && (B = 0 > y ? 0 : y > E[f] ? a(".dw-li", q).length : da(q, y) + 0), x && (D = 0 > z ? 0 : z > E[f] ? a(".dw-li", q).length : da(q, z) + 1));
						if (w || x || F) o ? a(".dw-li", q).slice(B, D).addClass("dw-v") : a(".dw-li",
							q).slice(B, D).removeClass("dw-v")
					}
				}))
			}
			...
			var t, S, T, G, ra, z, fa, Y, E, y = a.extend({}, e.settings),
				...
				q = {
					...
					i: function(a) {
						return i(a.getMinutes(), d, na, oa)
					},
					s: function(a) {
						return i(a.getSeconds(), O, ia, la)
					},
					u: function(a) {
				...
				o = B.match(/a/i),
				b = B.match(/h/),
				n = "datetime" == y ? r.dateFormat + r.separator +
				r.timeFormat : "time" == y ? r.timeFormat : r.dateFormat,
				V = new Date,
				x = r.steps || {},
			...
			if (y.match(/date/i)) {
				...
				for (S = 0; 3 > S; S++)
					if (S == F.y) {
						...
						ra = r.getYear(U);
						z = r.getYear(N);
						for (t = ra; t <= z; t++) T.push(t), G.push((p.match(/yy/i) ? t : (t + "").substr(2, 2)) + (r.yearSuffix || ""));
						I(x, T, G, r.yearText)
					} else if (S == F.m) {
					W++;
					G = [];
					T = [];
					for (t = 0; 12 > t; t++) ra = p.replace(/[dy]/gi, "").replace(/mm/, (9 > t ? "0" + (t + 1) : t + 1) + (r.monthSuffix || "")).replace(/m/, t + 1 + (r.monthSuffix || "")), T.push(t), G.push(ra.match(/MM/) ? ra.replace(/MM/,
						'<span class="dw-mon">' + r.monthNames[t] + "</span>") : ra.replace(/M/, '<span class="dw-mon">' + r.monthNamesShort[t] + "</span>"));
					I(x, T, G, r.monthText)
				} else if (S == F.d) {
					W++;
					G = [];
					T = [];
					for (t = 1; 32 > t; t++) T.push(t), G.push((p.match(/dd/i) && 10 > t ? "0" + t : t) + (r.daySuffix || ""));
					I(x, T, G, r.dayText)
				}
				R.push(x)
			}
			if (y.match(/time/i)) {
				...
				a.each(["h", "i", "s", "a"], function(a, b) {
					a = B.search(RegExp(b, "i")); - 1 < a && P.push({
						o: a,
						v: b
					})
				});
				...
				for (S = W; S <
					...
					if (S == F.h) {
						...
						G = [];
						T = [];
						for (t = M; t < (b ? 12 : 24); t += Z) T.push(t), G.push(b && 0 === t ? 12 : B.match(/hh/i) && 10 > t ? "0" + t : t);
						I(x, T, G, r.hourText)
					} else if (S == F.i) {
					W++;
					G = [];
					T = [];
					for (t = na; 60 > t; t += d) T.push(t), G.push(B.match(/ii/) && 10 > t ? "0" + t : t);
					I(x, T, G, r.minuteText)
				} else if (S == F.s) {
					W++;
					G = [];
					T = [];
					for (t = ia; 60 > t; t += O) T.push(t), G.push(B.match(/ss/) && 10 > t ? "0" + t : t);
					I(x, T, G, r.secText)
							...
							if (c == "d") {
								...
								H && a(".dw-li", h).each(function() {
									var b = a(this),
										...
										d = p.replace(/[my]/gi, "").replace(/dd/,
											(d < 10 ? "0" + d : d) + (r.daySuffix || "")).replace(/d/, d + (r.daySuffix || ""));
...
(function(a, m, c, l) {
	...
	L.calendar = function(c) {
		...
		function ba(b, n) {
			var l = y[b];
			if (l) {
				var m, d, q, o, p, r = '<ul class="dw-cal-event-list">';
				X = n;
				n.addClass(P).find(".dw-i").addClass(J);
				n.hasClass(F) && n.attr("data-hl",
					"true").removeClass(F);
				ka(l);
				a.each(l, function(a, b) {
					...
					var c = r,
						i = '<li role="button" aria-label="' + b.text + (m ? ", " + g.fromText + " " + m : "") + (d ? ", " + g.toText + " " + d : "") + '" class="dw-cal-event"><div class="dw-cal-event-color" style="' + (q ? "background:" + q + ";" : "") + '"></div><div class="dw-cal-event-text">' +
						(o.getTime && !p ? '<div class="dw-cal-event-time">' + e.datetime.formatDate(g.timeFormat, o) + "</div>" : "") + b.text + "</div>",
						n;
					if (b.start && b.end) {
						n = g.labelsShort;
						var l = Math.abs(b.end - b.start) / 1E3,
							...
							h = t / 24,
							v = h / 365;
						n = '<div class="dw-cal-event-dur">' + (45 > l && Math.round(l) + " " + n[5].toLowerCase() || 45 > s && Math.round(s) + " " + n[4].toLowerCase() || 24 > t && Math.round(t) + " " + n[3].toLowerCase() || 30 > h && Math.round(h) + " " + n[2].toLowerCase() || 365 > h && Math.round(h / 30) + " " + n[1].toLowerCase() || Math.round(v) + " " + n[0].toLowerCase()) +
							"</div>"
					} else n = "";
					r = c + (i + n + "</li>")
				});
		...
		var ea, x, R, X, y, t, S, T, G, ra, z, fa, Y, E, r, W = {};
		E = w({}, c.settings);
		...
		if (g.selectedValues)
			for (z = 0; z < g.selectedValues.length; z++) B[ja(g.selectedValues[z])] =
				g.selectedValues[z];
		...
		c.getDayProps = function(b) {
			for (var c = q ? B[b] !== l : H ? b.getTime() === (new Date).setHours(0, 0, 0, 0) : l, e = fa[b] ? fa[b][0] : !1, i = y[b] ? y[b][0] : !1, d = e || i, e = e.text || (i ? y[b].length + " " + (1 < y[b].length ? g.eventsText : g.eventText) : 0), i = fa[b] || y[b] || [], m = d.color, o = K && e ? f(m) : "", p = "", r = '<div class="dw-cal-day-m"' + (m ? ' style="background-color:' + m + ";border-color:" + m + " " + m + ' transparent transparent"' :
			...
			if ("bottom" == D) {
				...
				for (b = 0; b < i.length; b++) r += '<div class="dw-cal-day-m-c"' + (i[b].color ? ' style="background:' + i[b].color + ';"' : "") + "></div>";
				r += "</div></div>"
			}
			return {
				marked: d,
				...
				ariaLabel: K || H ? e : "",
				markup: K && e ?
					'<div class="dw-cal-day-txt-c"><div class="dw-cal-day-txt ' + (g.eventTextClass || "") + '" title="' + a("<div>" + e + "</div>").text() + '"' + (m ? ' style="background:' + m + ";color:" + o + ';text-shadow:none;"' : "") + ">" + p + e + "</div></div>" : K && p ? '<div class="dw-cal-day-ic-c">' + p + "</div>" : d ? r : ""
			}
		};
		...
		H && (c.addEvent = function(b) {
			...
			var e;
			return a ? (a.setHours(0, 0, 0, 0), e = c.prepareObj(o, a.getFullYear(),
				a.getMonth()), e[a] ? ka(e[a]) : []) : o
		...
		w(E, {
			...
			formatValue: function(a) {
				var e, f = [];
				if (q) {
					for (e in B) f.push(v.formatDate(c.format,
						B[e], g));
					return f.join(", ")
				}
			...
			onDayChange: function(b) {
				...
				if (H) {
					...
					l.hasClass("dw-cal-day-ev") || setTimeout(function() {
						c.changing ? r = {
							d: f,
							full: l.attr("data-full")
						} : ba(f, l)
					}, 10)
				} else if (q)
					if (g.selectType == "week") {
						var d, m, o = f.getDay() - ra,
							o = o < 0 ? 7 + o : o;
						g.multiSelect || (B = {});
						for (d = 0; d < 7; d++) {
						...
						d =
							a('.dw-cal .dw-cal-day[data-full="' + l.attr("data-full") + '"]', x);
						if (b) {
...
(function(a) {
	...
	if (/Android/i.test(c)) {
		...
		if (m = "ios", c = navigator.userAgent.match(/OS\s+([\d\_]+)/i)) c = c[0].replace(/_/g, ".").replace("OS ", ""), m = "7" <=
			c ? "ios" : "ios-classic"
