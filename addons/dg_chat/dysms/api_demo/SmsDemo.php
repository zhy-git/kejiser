...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIfmGJR64yJIif"; // AccessKeyId

        $accessKeySecret = "SZwfbfmTeOuEvRbe4mDX5mX3c73Qvk"; // AccessKeySecret
    ...
    public static function sendSms($phone) {
        ...
        $request->setSignName("圆梦学海");
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_147975589");
        ...
        if($res['Code'] == 'OK')
        {
            $data = ['phone'=>$phone,'code'=>$code,'create_time'=>time()];
            $result = [
                'code'=>1,
                'msg'=>'发送成功',
                'data'=>$data
        ...
        {
            $result = ['code'=>0,'msg'=>$res['Message'],'data'=>''];
        }
        return $result;
    }
