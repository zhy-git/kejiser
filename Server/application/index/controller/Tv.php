...
class tv extends Controller
{
    ...
    public function create()
    {
        ...
        if(!in_array($_FILES['img']['type'],$xzv_99))
        {
        ...
        if ($xzv_19) {
            ...
            if ($xzv_20) {
                ...
                $xzv_14 = 'http://live.0561cc.cc/public/uploads/' . $xzv_20->getSaveName();
    ...
    public function edit()
    {
        ...
        if ($xzv_15) {
            ...
            if ($xzv_8) {
                ...
                $xzv_12 = 'http://live.0561cc.cc/public/uploads/' . $xzv_8->getSaveName();
