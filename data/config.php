...
$config['db']['master']['username'] = 'yidazhong';
$config['db']['master']['password'] = 'abc19861118';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'yidazhong';
...
$config['setting']['authkey'] = '374de006';
