...
<div class="main">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#">打赏<?php  echo $_GPC['do'];?>列表</a></li>
        <li><a  href="<?php  echo $this->createWebUrl('Newds',array('rid' => $rid,'turntable'=>$turntable));?>">添加打赏<?php  echo $_GPC['do'];?></a></li>
    </ul>
	<div class="category">
