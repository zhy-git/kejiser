...
<ul class="nav nav-tabs">
    ...
    <li  class="active"><a  href="<?php  echo $this->createWebUrl('mobile_code');?>">签到手机号管理</a></li>
...
<div class="main">
    ...
    <div class="panel-heading">
        签到手机号管理(<span style="color: #FF0000">请先在回复规则列表添加活动规则，然后点击右侧添加按钮</span>)
    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php  echo $this->createWebUrl('mobile_code_setting',array('rid' => $row['id'],'op' => 'post'))?>" class="btn btn-primary btn-sm"> 签到手机号管理</a>
