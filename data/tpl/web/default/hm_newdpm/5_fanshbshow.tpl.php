                ...
                <div class="panel-body table-responsive">
                    <table class="table table-hover" >
                        ...
                        <tr>
                            ...
                            <td><?php  echo $row['actual_money'];?></td>
                            <td><?php  echo $row['money'];?></td>
                            <td><?php  echo $row['counter'];?>%</td>

                            <td><?php  if($row['desknum']==1) { ?>随机<?php  } else { ?>均分<?php  } ?></td>
                            <td><?php  echo $row['hbnum'];?></td>
                            <td><?php  echo $row['usesnum'];?></td>
                            <td><?php  echo $row['usemoney'];?></td>
                            <td><?php  echo $row['says'];?></td>
                            <td><?php  echo $row['rulename'];?></td>
                            <td>
                                <a class="btn btn-default xiangqing userinfo4" href="javascript:void(0)"  data-placement="top" title="详情" id="<?php  echo $row['id'];?>"><i class="fa fa-bullseye" ></i></a>
