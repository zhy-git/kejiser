...
<ul class="nav nav-tabs">
    <li  class="active"><a  href="<?php  echo $this->createWebUrl('shopping');?>">商城管理</a></li>
    <li><a  href="<?php  echo $this->createWebUrl('web_deposit');?>">寄存管理</a></li>
</ul>
...
<div class="main">
    ...
    <div class="panel-heading">
        商城列表(<span style="color: #FF0000">请先在回复规则列表添加活动规则，然后点击右侧添加按钮</span>)
    </div>
