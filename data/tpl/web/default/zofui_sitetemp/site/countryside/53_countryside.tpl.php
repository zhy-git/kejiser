		...
		<form method="post" action="" style="margin-left: 100px">
			...
			<div class="frm_control_group">
				...
				<div class="frm_controls msg">
					<span class="frm_textarea_box textarea_60px" style="height:auto;">
						<textarea disabled="disabled"  name="title" class="frm_textarea" rows="1" placeholder="" style="height:auto;"><?php  echo $info['userinfo']['title'];?></textarea>
					</span>
				</div>
			</div>
			<div class="frm_control_group">
				...
				<div class="frm_controls msg">
					<span class="frm_input_box">
						<input type="text" class="frm_input" disabled="disabled"   name="number" value="<?php  echo $info['number'];?>">
					</span>
				    		...
				    		<a href="javascript:;" class="btn dropdown_switch jsDropdownBt width_200" disabled="disabled" >
				    			<label class="jsBtLabel" >
				    				<?php  if(is_array($artsort)) { foreach($artsort as $item) { ?>
				    					<?php  if($item['id'] == $info['userinfo']['prosortid']) { ?>
				    						<?php  echo $item['name'];?>
				    					<?php  } ?>
				    				<?php  } } ?>
				    			</label>
			...
			<div class="frm_control_group single_img_upload">
				...
				<div class="frm_controls">
					...
					<img src="/attachment/<?php  echo $info['userinfo']['img']['1'];?>" width="130px" height="174px" id='pic'>
				</div>
			</div>
			...
			<div class="frm_control_group">
				...
				<div class="frm_controls msg">
					<span class="frm_textarea_box textarea_60px" style="height:auto;">
						<textarea disabled="disabled"  name="title" class="frm_textarea" rows="1" placeholder="" style="height:auto;"><?php  echo $info['name'];?></textarea>
					</span>
				</div>
			</div>
			<div class="frm_control_group">
				...
				<div class="frm_controls msg">
					<span class="frm_textarea_box textarea_60px" style="height:auto; width:67%;">
						<textarea disabled="disabled"  name="title" class="frm_textarea" rows="1" placeholder="" style="height:auto;"><?php  echo $info['seraddress'];?></textarea>
					</span>
				</div>
			</div>
			...
			<div class="frm_control_group">
				...
				<div class="frm_controls msg">
                        ...
                        <div class="containe">
                          ...
                          <?php  if(is_array($info['img'])) { foreach($info['img'] as $item) { ?>
					        <a target="_blank" href="<?php  echo $item;?>" title="点击查看大图"><img src="<?php  echo $item;?>" width="150" height="100"></a>
                          <?php  } } ?>
			...
			<div class="frm_control_group textarea_item">
				...
				<div class="frm_controls">
					<span class="frm_textarea_box" style="width:100%;">
						<textarea disabled="disabled"  name="title" class="frm_textarea" rows="1"><?php  echo $info['content'];?></textarea>
					</span>
