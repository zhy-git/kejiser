		...
		<div class="temp_page_box">
			<?php  if(is_array($list)) { foreach($list as $item) { ?>
				<div class="temp_page_item ">
					...
					<div class="temp_item_thumb">
						...
						<div class="temp_page_settemp">
							...
							<div class="opclass" >
								<!-- <a class="editsystem settemp_btnr tocloud" id="<?php  echo $item['id'];?>" href="javascript:;">推至云端</a>
								 -->
								 <a href="<?php  echo self::pwUrl('site','page',array('op'=>'list','tid'=>$item['id']))?>">点击编辑</a>
							</div>
							<?php  } ?>							
						</div>
						<?php  } ?>
					...
					<?php  if($item['issystem'] == 1) { ?>
						<?php  if($item['issetsystem'] == 1) { ?> 
							...
							<div class="item_cell_box temp_item_bot">
								<li class="item_cell_flex"><a href="javascript:;" class="temptopage" type="tomy" id="<?php  echo $item['id'];?>">导出使用</a></li>
							...
							<div class="item_cell_box temp_item_bot">
								...
								<li class="item_cell_flex tc">
									<a href="<?php  echo self::pwUrl('site','page',array('op'=>'design','op'=>'bar','tid'=>$item['id']))?>">设置导航</a>
								</li>
					...
					<?php  } else { ?>
						<div class="item_cell_box temp_item_bot">
							<li style="margin-right:10px;"><a href="<?php  echo self::pwUrl('site','page',array('op'=>'list','tid'=>$item['id']))?>">页面列表</a></li>
							<!-- <li class="item_cell_flex tc"><a href="<?php  echo self::pwUrl('site','page',array('op'=>'add','tid'=>$item['id']))?>">添加页面</a></li> -->
							<li><a href="<?php  echo self::pwUrl('site','page',array('op'=>'design','op'=>'bar','tid'=>$item['id']))?>">设置导航</a></li>
						</div>
						<div class="item_cell_box temp_item_bot" style="display: none;">
