...
<div class="api" id="js-statistics-app-display" ng-controller="HorizontalBarCtrl" ng-cloak>
	<div class="panel we7-panel api-target" ng-if="needAccountApi">
		<div class="panel-heading">API余量</div>
		<div class="panel-body we7-padding-vertical">
			<div class="col-sm-4 text-center">
				<div class="title"><span class="">月访问总次数</span><a href="<?php  echo url('account/post', array('uniacid' => $_W['uniacid'], 'acid' => $_W['acid'], 'account_type' => $_W['account']['type']))?>" class="pull-right color-default font-default" target="_blank">去设置</a></div>
	...
	<div class="panel we7-panel" ng-if="needAccountApi">
